...
Router::connect('/zaloguj', array('plugin' => 'paszport', 'controller' => 'users', 'action' => 'failed'));
Router::connect('/logowanie', array('plugin' => 'paszport', 'controller' => 'users', 'action' => 'failed'));
