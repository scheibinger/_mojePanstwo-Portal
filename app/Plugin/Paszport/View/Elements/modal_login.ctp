            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="or nomargin col-xs-12 col-sm-10 col-sm-offset-1">
                        <span class="middle">Zaloguj się przez swoje konto Facebook</span>
                    </div>
                    
                    
                    <div class="logInVia col-xs-12">
                        <div class="content text-center">
                            <?php echo $this->Html->link('<i class="fa fa-facebook"></i> Zaloguj mnie', array('action' => 'fblogin'), array('class' => 'btn btn-facebook btn-md', 'target' => '_blank', 'escape' => false)); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="or col-xs-12 col-sm-10 col-sm-offset-1">
                        <span class="middle">Zaloguj się przez konto email</span>
                    </div>
                </div>
...
<<<<<<< HEAD
                */ ?>
                ...
                <div class="row">
                    <div class="or col-xs-12 col-sm-10 col-sm-offset-1">
                        <span class="middle"><a href="users/register">Wyrób paszport na Twoje konto email</a></span>
                    </div>
                </div>
