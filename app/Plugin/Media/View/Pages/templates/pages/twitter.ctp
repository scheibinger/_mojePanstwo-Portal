        ...
        <div class="row">
	        <div class="col-md-8 col-md-offset-2">
	            <div class="desc main_desc">
	                <p style="padding: 20px 0; border-bottom: 1px solid #CCC;">Przeglądaj najpopularniejsze treści na Twitterze dotyczące spraw publicznych. Monitorujemy aktywność urzędników, urzędów, organizacji pozarządowych oraz komentatorów. Zobacz także nasz <a href="/media/2013">raport o aktywności Państwa w Internecie w 2013 roku</a>.</p>
