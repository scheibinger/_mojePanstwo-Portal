            ...
            <div class="objectsPageContent main">
                <div class="object">
                    ...
                    <div class="block bg">
                        ...
                        <div id="rada" class="block-header">
                            <h2 class="pull-left"><?php echo __d('dane', 'LC_GMINY_WYNIKI_WYBOROW'); ?></h2>
                            <a class="btn btn-default btn-sm pull-right"
                               href="/dane/gminy/<?= $object->getId() ?>/radni">Zobacz wszystkich radnych</a>
                        </div>
                    ...
                    <div class="block">
                        ...
                        <div id="zamowienia_publiczne" class="block-header">
                            <h2 class="pull-left">Zamówienia publiczne</h2>
                            <a class="btn btn-default btn-sm pull-right"
                               href="/dane/gminy/<?= $object->getId() ?>/zamowienia">Zobacz wszystkie</a>
                        </div>
                    ...
                    <div class="block bg">
                        ...
                        <div id="dotacje_unijne" class="block-header">
                            <h2 class="pull-left">Dotacje unijne</h2>
                            <a class="btn btn-default btn-sm pull-right"
                               href="/dane/gminy/<?= $object->getId() ?>/dotacje_ue">Zobacz wszystkie</a>
                        </div>
                    ...
                    <div class="block">
                        ...
                        <div id="organizacje" class="block-header">
                            <h2 class="pull-left">Organizacje w tej gminie</h2>
                            <a class="btn btn-default btn-sm pull-right"
                               href="/dane/gminy/<?= $object->getId() ?>/organizacje">Zobacz wszystkie</a>
                        </div>
