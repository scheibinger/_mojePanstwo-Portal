...
<div class="col-md-10 col-md-offset-1">
	<div id="powiazania" class="object mpanel">
		...
		<h1>Powiązania radnych gminy <?= $object->getData('nazwa') ?> z organizacjami w <a href="/krs">Krajowym Rejestrze Sądowym</a></h1>
		...
		<div class="block-group">
			...
			<div class="block">
		        ...
		        <div class="block-header">
		            <h2 class="label"><a href="/dane/gminy/<?= $object->getId() ?>/radni/<?= $p['radny']['id'] ?>"><?= $p['radny']['nazwa'] ?></a></h2>
		        ...
		        <div class="content row">
			        ...
			        <div class="col-md-2">
			        	...
			        	<? if( $p['radny']['avatar']=='1' ) {?>
			        	<img src="http://resources.sejmometr.pl/avatars/5/<?= $p['radny']['avatar_id'] ?>.jpg" />
			        ...
			        <div class="col-md-10">
						...
						?>
				        	<li>
				        		<a href="/dane/krs_podmioty/<?= $o['id'] ?>"><?= stripslashes($o['nazwa']) ?></a> <span class="badge"><?= implode('</span> <span class="badge">', $badges) ?></span>
				        	</li>
				        <? } ?>
				        </ul>
