        ...
        <div class="objectSideInner">
            <ul class="dataHighlights side">
	            ...
	            <li class="dataHighlight big">
                    ...
                    <p class="pull-right nopadding"><a class="btn btn-sm btn-default" href="/dane/gminy/<?= $object->getId() ?>/okregi_wyborcze/<?= $radny->getData('okreg_id') ?>">Wyniki w okręgu &raquo;</a></p>
	            </li>
            ...
            <div class="block-group">
            	...
            	<div id="dyzury" class="block">
		            ...
		            <div class="block-header">
			            ...
			            <a class="btn btn-default btn-sm pull-right" href="/dane/gminy/<?= $object->getId() ?>/radni/<?= $radny->getId() ?>/dyzury">Zobacz wszystkie dyżury</a>
		            </div>
		            	...
		            	<ul>
					    	<li style="margin: 15px 0;">
					    		<div class="row">
						    		...
						    		<div class="col-md-2">
						    			<a href="http://example.com/link-to-your-event" title="Dodaj do kalendarza" class="addthisevent">
										    Dodaj do kalendarza
										    <? if($d['timestart'] && ($d['timestart']!='0000-00-00 00:00:00')) {?><span class="_start"><?= $d['timestart'] ?></span><? } ?>
										    <? if($d['timestop'] && ($d['timestop']!='0000-00-00 00:00:00')) {?><span class="_end"><?= $d['timestop'] ?></span><? } ?>
										    <span class="_zonecode">41</span>
										    <span class="_summary">Dyżur poselski <?= $radny->getData('nazwa') ?></span>
										    <span class="_description"><?= $d['godz_str'] ?>, <?= $d['adres'] ?></span>
										    <span class="_location"><?= $d['adres_wiecej'] ?></span>
										    <span class="_organizer"><?= $radny->getData('nazwa') ?></span>
										    <span class="_organizer_email"><?= $radny->getData('email') ?></span>
										    <span class="_all_day_event"><? if($d['timestart'] && ($d['timestart']!='0000-00-00 00:00:00') && $d['timestop'] && ($d['timestop']!='0000-00-00 00:00:00'))  {?>false<? } else { ?>true<? } ?></span>
            	...
            	<div id="wystapienia" class="block">
		            ...
		            <div class="block-header">
			            ...
			            <a class="btn btn-default btn-sm pull-right" href="/dane/gminy/<?= $object->getId() ?>/radni/<?= $radny->getId() ?>/wystapienia">Zobacz wszystkie</a>
		            </div>
            	...
            	<div id="interpelacje" class="block">
		            ...
		            <div class="block-header">
    		            ...
    		            <a class="btn btn-default btn-sm pull-right" href="/dane/gminy/<?= $object->getId() ?>/radni/<?= $radny->getId() ?>/interpelacje">Zobacz wszystkie</a>
