...
?>
	...
	<div class="header subobject row">
		<p class="subtitle">
			<a href="/dane/gminy/<?= $okreg->getData('gmina_id') ?>/okregi_wyborcze"><span class="glyphicon glyphicon-align-justify"></span> Okręgi wyborcze w wyborach samorządowych 2010 r.</a>
		</p>
