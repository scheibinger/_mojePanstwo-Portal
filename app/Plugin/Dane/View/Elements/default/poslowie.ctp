...
<?php } else { ?>
    <p class="line signature"><?php echo __d('dane', 'LC_DANE_POSLOWIE_PROFESSION', true) . ': <strong>' . $item['data']['zawod'] . '</strong>'; ?></p>
    <p class="line signature"><?php echo __d('dane', 'LC_DANE_AGE', true) . ': <strong>' . $this->Czas->wiek($item['data']['data_urodzenia']) . '</strong>'; ?></p>
