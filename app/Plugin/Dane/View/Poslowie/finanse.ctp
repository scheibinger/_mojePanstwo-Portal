	            	...
	            	<div id="projekty_za" class="block">
                        <div class="block-header">
                            ...
                            <a class="btn btn-default btn-sm pull-right"
                               href="/dane/poslowie/<?= $object->getId() ?>/oswiadczenia_majatkowe">Zobacz wszystkie</a>
                        </div>
					        ...
					        <table class="table table-wydatki table-striped ">
								<thead>
									...
									<? for( $r = 0; $r < $liczba_rocznikow; $r++ ) {?>
										<th><?= $wydatki['roczniki'][$r]['rok'] ?> <a data-dokument_id="<?= $wydatki['roczniki'][$r]['dokument_id'] ?>" href="/dane/poslowie/<?= $object->getId() ?>/finanse/<?= $wydatki['roczniki'][$r]['rok'] ?>" class="glyphicon glyphicon-file"></a></th>
									<? } ?>
									</tr>
								</thead>
								<tbody>
