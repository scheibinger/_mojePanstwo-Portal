    ...
    "area.radial": {
        ...
        "innerRadius defaults to a function accessor": function (area) {
            ...
            assert.pathEqual(a([
                ...
                [20, 2],
                [10, 3]
            ]), "M0,-10L16.829420,-10.806046L18.185949,8.322937L1.411200,9.899925L0,-10L0,-20L0,-20L0,-10Z");
        ...
        "innerRadius can be defined as a constant": function (area) {
            ...
            assert.pathEqual(a([
                ...
                [20, 2],
                [10, 3]
            ]), "M0,-10L16.829420,-10.806046L18.185949,8.322937L1.411200,9.899925L0,-30L0,-30L0,-30L0,-30Z");
        ...
        "outerRadius can be defined as a constant": function (area) {
            ...
            assert.pathEqual(a([
                ...
                [20, 2],
                [10, 3]
            ]), "M0,-30L25.244130,-16.209069L27.278923,12.484405L4.233600,29.699775L0,-10L0,-20L0,-20L0,-10Z");
        ...
        "startAngle can be defined as a constant": function (area) {
            ...
            assert.pathEqual(a([
                ...
                [20, 2],
                [10, 3]
            ]), "M0,-10L16.829420,-10.806046L18.185949,8.322937L1.411200,9.899925L10,0L20,0L20,0L10,0Z");
        ...
        "endAngle can be defined as a constant": function (area) {
            ...
            assert.pathEqual(a([
                ...
                [20, 2],
                [10, 3]
            ]), "M10,0L20,0L20,0L10,0L0,-10L0,-20L0,-20L0,-10Z");
        ...
        "if innerRadius === outerRadius, radius is only evaluated once per point": function (area) {
            ...
            assert.pathEqual(a.call(t, [
                ...
                [20, 2],
                [10, 3]
            ]), "M0,-30L25.244130,-16.209069L27.278923,12.484405L4.233600,29.699775L0,-30L0,-30L0,-30L0,-30Z");
            assert.deepEqual(dd, [
                [10, 0],
                [20, 1],
                [20, 2],
        ...
        "if startAngle === endAngle, angle is only evaluated once per point": function (area) {
            ...
            assert.pathEqual(a.call(t, [
                ...
                [20, 2],
                [10, 3]
            ]), "M10,0L20,0L20,0L10,0L10,0L20,0L20,0L10,0Z");
            assert.deepEqual(dd, [
                [10, 0],
                [20, 1],
                [20, 2],
        ...
        "interpolate can be defined as a constant": function (area) {
            ...
            assert.pathEqual(a([
                [0, 0],
                [1, 1]
            ]), "M0,0V-0.540302H0.841471L0,-1H0V0Z");
...
function testInterpolation(interpolate) {
    ...
    var cartesian = _.svg.area()
        .x0(function (d) {
            return d[0] * Math.cos(d[1] - Math.PI / 2);
        })
        .x1(function (d) {
            return 2 * d[0] * Math.cos(d[1] - Math.PI / 2);
        })
        .y0(function (d) {
            return d[0] * Math.sin(d[1] - Math.PI / 2);
        })
        .y1(function (d) {
            return 2 * d[0] * Math.sin(d[1] - Math.PI / 2);
        });
