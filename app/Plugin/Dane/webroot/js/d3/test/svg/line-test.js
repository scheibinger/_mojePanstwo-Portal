        ...
        "interpolate(basis)": {
            ...
            "supports basis-open interpolation": function (line) {
                ...
                assert.pathEqual(l([
                    ...
                    [3, 1],
                    [4, 0]
                ]), "M1,0.6666666666666666C1.3333333333333333,0.6666666666666666,1.6666666666666665,0.3333333333333333,2,0.3333333333333333C2.333333333333333,0.3333333333333333,2.6666666666666665,0.6666666666666666,3,0.6666666666666666");
            },
        ...
        "interpolate(cardinal)": {
            "supports cardinal interpolation": function (line) {
                ...
                assert.pathEqual(l([
                    ...
                    [3, 1],
                    [4, 0]
                ]), "M0,0Q0.8,1,1,1C1.3,1,1.7,0,2,0S2.7,1,3,1Q3.2,1,4,0");
            },
            "supports cardinal-open interpolation": function (line) {
                ...
                assert.pathEqual(l([
                    ...
                    [3, 1],
                    [4, 0]
                ]), "M1,1C1.3,1,1.7,0,2,0S2.7,1,3,1");
            },
            "supports cardinal-closed interpolation": function (line) {
                ...
                assert.pathEqual(l([
                    ...
                    [3, 1],
                    [4, 0]
                ]), "M0,0C-0.45,0.15,0.7,1,1,1S1.7,0,2,0S2.7,1,3,1S4.45,0.15,4,0S0.45,-0.15,0,0");
            },
            ...
            "observes the specified tension": function (line) {
                var l = line().tension(.5);
                assert.pathEqual(l.interpolate("cardinal")([
                    [0, 0],
                    [1, 1],
                    [2, 0],
                    [3, 1],
                    [4, 0]
                ]), "M0,0Q0.6666666666666667,1,1,1C1.5,1,1.5,0,2,0S2.5,1,3,1Q3.3333333333333335,1,4,0");
                assert.pathEqual(l.interpolate("cardinal-open")([
                    [0, 0],
                    [1, 1],
                    [2, 0],
                    [3, 1],
                    [4, 0]
                ]), "M1,1C1.5,1,1.5,0,2,0S2.5,1,3,1");
                assert.pathEqual(l.interpolate("cardinal-closed")([
                    [0, 0],
                    [1, 1],
                    [2, 0],
                    [3, 1],
                    [4, 0]
                ]), "M0,0C-0.75,0.25,0.5,1,1,1S1.5,0,2,0S2.5,1,3,1S4.75,0.25,4,0S0.75,-0.25,0,0");
            }
        },
        ...
        "interpolate(monotone)": {
            "supports monotone interpolation": function (line) {
                ...
                assert.pathEqual(l([
                    ...
                    [3, 0],
                    [4, 0]
                ]), "M0,0C0.08333333333333333,0.08333333333333333,0.6666666666666667,1,1,1S1.6666666666666667,1,2,1S2.6666666666666665,0,3,0S3.8333333333333335,0,4,0");
            },
