    ...
    "path": {
        ...
        "with an equirectangular projection": {
            ...
            "area": {
                ...
                "of a polygon with no holes": function (area) {
                    assert.strictEqual(area({type: "Polygon", coordinates: [
                        [
                            [100, 0],
                            [100, 1],
                            [101, 1],
            ...
            "centroid": {
                ...
                "of a singleton multipoint": function (centroid) {
                    assert.deepEqual(centroid({type: "MultiPoint", coordinates: [
                        [0, 0]
                    ]}), [480, 250]);
                },
                ...
                "of a linestring with two points": function (centroid) {
                    assert.deepEqual(centroid({type: "LineString", coordinates: [
                        [100, 0],
                        [0, 0]
                    ]}), [730, 250]);
                    assert.deepEqual(centroid({type: "LineString", coordinates: [
                ...
                "of a multilinestring": function (centroid) {
                    assert.deepEqual(centroid({type: "MultiLineString", coordinates: [
                        [
                            [100, 0],
                            [0, 0]
                        ],
        ...
        "with the default context (null) and default projection (albers-usa)": {
            ...
            "area of a polygon": function (p) {
                var area = p.area({type: "Polygon", coordinates: [
                    [
                        [-122, 37],
                        [-71, 42],
                        [-80, 25],
            ...
            "bounds of a line string": function (p) {
                assert.inDelta(p.bounds({type: "LineString", coordinates: [
                    [-122, 37],
                    [-74, 40],
                    [-100, 0]
                ]}),
            ...
            "centroid of a line string": function (p) {
                assert.inDelta(p.centroid({type: "LineString", coordinates: [
                    [-122, 37],
                    [-74, 40],
                    [-100, 0]
...
var antarctica = {type: "Polygon", coordinates: [
    [
        [-58.61414, -64.15246],
        [-59.04507, -64.36800],
        [-59.78934, -64.21122],
