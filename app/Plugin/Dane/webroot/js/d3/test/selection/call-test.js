    ...
    "select(body)": {
        ...
        "on a simple page": {
            ...
            "passes any optional arguments": function (body) {
                var abc;
                body.call(function (selection, a, b, c) {
                    abc = [a, b, c];
                }, "a", "b", "c");
            ...
            "returns the current selection": function (body) {
                assert.isTrue(body.call(function () {
                }) === body);
            }
        }
    }
    ...
    "selectAll(div)": {
        ...
        "on a simple page": {
            ...
            "passes any optional arguments": function (div) {
                var abc;
                div.call(function (selection, a, b, c) {
                    abc = [a, b, c];
                }, "a", "b", "c");
                assert.deepEqual(abc, ["a", "b", "c"]);
            },
            ...
            "returns the current selection": function (div) {
                assert.isTrue(div.call(function () {
                }) === div);
            }
        }
    }
