...
module.exports = {
    ...
    "preserves matching elements": function (span) {
        var some = span.filter(function (d, i) {
            return i === 0;
        });
    ...
    "removes non-matching elements": function (span) {
        var some = _.merge(span.filter(function (d, i) {
            return d & 1;
        }));
    ...
    "returns a new selection": function (span) {
        assert.isFalse(span.filter(function () {
            return 1;
        }) === span);
    },
