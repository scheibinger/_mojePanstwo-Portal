...
(function () {
    ...
    function H(a, b, c) {
        var d, e;
        if (ma(b))t(c) ? a.setAttribute(b,
            c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (t(b) && aa(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    function z(a, b) {
        if (Fa && b && b.opacity !== r)b.filter = "alpha(opacity=" + b.opacity * 100 + ")";
        u(a.style, b)
    }
    ...
    function Z(a, b, c, d, e) {
        a = F.createElement(a);
        b && u(a, b);
        e && z(a, {padding: 0, border: ba, margin: 0});
        c && z(a, c);
        d && d.appendChild(a);
        return a
    }
    ...
    function Ga(a, b, c, d) {
        var e = L.lang, a = +a || 0, f = b === -1 ? (a.toString().split(".")[1] || "").length : isNaN(b = O(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(E(a = O(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
    ...
    function pa(a, b) {
        ...
        if (b)throw c; else V.console && console.log(c)
    }
    ...
    function Lb() {
        var a = L.global.useUTC, b = a ?
            "getUTC" : "get", c = a ? "setUTC" : "set";
        Ja = (a && L.global.timezoneOffset || 0) * 6E4;
    ...
    function Bb(a) {
        var b = a.options, c = b.navigator,
            d = c.enabled, b = b.scrollbar, e = b.enabled, f = d ? c.height : 0, g = e ? b.height : 0;
        this.handles = [];
    ...
    var r, F = document, V = window, T = Math, v = T.round, Q = T.floor, Va = T.ceil, s = T.max, y = T.min, O = T.abs, ca = T.cos, ha = T.sin, Ka = T.PI, La = Ka * 2 / 360, za = navigator.userAgent,
        Rb = V.opera, Fa = /msie/i.test(za) && !Rb, lb = F.documentMode === 8, mb = /AppleWebKit/.test(za), bb = /Firefox/.test(za), cb = /(Mobile|Android|Windows Phone)/.test(za), Ma = "http://www.w3.org/2000/svg", da = !!F.createElementNS && !!F.createElementNS(Ma, "svg").createSVGRect, Yb = bb && parseInt(za.split("Firefox/")[1], 10) < 4, ka = !da && !Fa && !!F.createElement("canvas").getContext, Za, db = F.documentElement.ontouchstart !== r, Sb = {}, Db = 0, hb, L, ra, wa, Eb, B, la = function () {
        }, Wa = [], Ta = "div", ba = "none", Zb = /^[0-9]+$/, Tb = "rgba(192,192,192," + (da ? 1.0E-4 :
            0.002) + ")", Ub = "stroke-width", ib, Ja, wb, xb, yb, Ua, jb, kb, Mb, Nb, zb, Ob, Pb, D = {};
    V.Highcharts = V.Highcharts ? pa(16, !0) : {};
    ra = function (a, b, c) {
        if (!t(b) || isNaN(b))return"Invalid date";
        var a = o(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b - Ja), e, f = d[xb](), g = d[yb](), h = d[Ua](), i = d[jb](), j = d[kb](), k = L.lang, l = k.weekdays, d = u({a: l[g].substr(0, 3), A: l[g], d: Qa(h), e: h, b: k.shortMonths[i], B: k.months[i], m: Qa(i + 1), y: j.toString().substr(2, 2), Y: j, H: Qa(f), I: Qa(f % 12 || 12), l: f % 12 || 12, M: Qa(d[wb]()), p: f < 12 ? "AM" : "PM", P: f < 12 ? "am" : "pm", S: Qa(d.getSeconds()),
            L: Qa(v(b % 1E3), 3)}, Highcharts.dateFormats);
    ...
    B = gb("millisecond", 1, "second", 1E3, "minute", 6E4, "hour", 36E5, "day", 864E5, "week", 6048E5, "month", 26784E5, "year", 31556952E3);
    Eb = {init: function (a, b, c) {
        var b = b || "", d = a.shift, e = b.indexOf("C") > -1,
            f = e ? 7 : 3, g, b = b.split(" "), c = [].concat(c), h, i, j = function (a) {
    ...
    (function (a) {
        V.HighchartsAdapter = V.HighchartsAdapter || a && {init: function (b) {
            ...
            a.fn.highcharts = function () {
                ...
                c = b[0];
                if (c !== r)c.chart = c.chart || {}, c.chart.renderTo = this[0], new Highcharts[a](c, b[1]), d = this;
                c === r && (d = Wa[H(this[0], "data-highcharts-chart")]);
                return d
            }
    ...
    var R = V.HighchartsAdapter, K = R || {};
    R && R.init.call(R, Eb);
    var nb = K.adapterRun, $b = K.getScript, Aa = K.inArray, q = K.each,
        Fb = K.grep, ac = K.offset, Na = K.map, A = K.addEvent, X = K.removeEvent, N = K.fireEvent, bc = K.washMouseEvent, ob = K.animate, eb = K.stop, K = {enabled: !0, x: 0, y: 15, style: {color: "#666", cursor: "default", fontSize: "11px"}};
    L = {colors: "#2f7ed8,#0d233a,#8bbc21,#910000,#1aadce,#492970,#f28f43,#77a1e5,#c42525,#a6c96a".split(","), symbols: ["circle", "diamond", "square", "triangle", "triangle-down"], lang: {loading: "Loading...", months: "January,February,March,April,May,June,July,August,September,October,November,December".split(","), shortMonths: "Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","),
        ...
        marker: {enabled: !0, lineWidth: 0, radius: 4, lineColor: "#FFFFFF", states: {hover: {enabled: !0}, select: {fillColor: "#FFFFFF", lineColor: "#000000", lineWidth: 2}}}, point: {events: {}}, dataLabels: w(K, {align: "center", enabled: !1, formatter: function () {
        ...
        shadow: !0, snap: cb ? 25 : 10, style: {color: "#333333", cursor: "default", fontSize: "12px", padding: "8px", whiteSpace: "nowrap"}}, credits: {enabled: !0, text: "Highcharts.com", href: "http://www.highcharts.com", position: {align: "right", x: -10, verticalAlign: "bottom", y: -5}, style: {cursor: "pointer", color: "#909090", fontSize: "9px"}}};
    var S = L.plotOptions, R = S.line;
    Lb();
    var cc = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, dc = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/, ec =
        ...
        return{get: function (c) {
            ...
            if (d)q(d, function (b) {
                ...
                var c;
                for (c = 0; c < 3; c++)b[c] += E(a * 255), b[c] < 0 && (b[c] = 0), b[c] > 255 && (b[c] = 255)
            }
            return this
    ...
    xa.prototype = {init: function (a, b) {
        this.element = b === "span" ? Z(b) : F.createElementNS(Ma, b);
        this.renderer = a;
        this.attrSetters = {}
        ...
        var c, d, e, f, g = this.element, h = g.nodeName.toLowerCase(), i = this.renderer, j, k = this.attrSetters, l = this.shadows, m, p, n = this;
        ma(a) && t(b) && (c = a, a = {}, a[c] = b);
        if (ma(a))c = a, h === "circle" ? c = {x: "cx", y: "cy"}[c] || c : c === "strokeWidth" && (c = "stroke-width"), n = H(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && c !== "fill" && (n = parseFloat(n)); else {
            for (c in a)if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                ...
                if (c === "d")d && d.join && (d = d.join(" ")), /(NaN| {2}|^$)/.test(d) &&
                    ...
                    "stroke-dasharray", d = d && d.toLowerCase(), d === "solid")d = ba; else {
                    if (d) {
                        ...
                        for (e = d.length; e--;)d[e] = E(d[e]) * o(a["stroke-width"], this["stroke-width"]);
                        d = d.join(",")
                    }
                } else if (c === "width")d = E(d); else if (c === "align")c = "text-anchor", d = {left: "start", center: "middle", right: "end"}[d];
                ...
                if (c === "stroke-width" || c === "stroke") {
                    this[c] = d;
                    if (this.stroke && this["stroke-width"])H(g, "stroke", this.stroke), H(g, "stroke-width", this["stroke-width"]), this.hasStroke = !0; else if (c === "stroke-width" && d === 0 && this.hasStroke)g.removeAttribute("stroke"), this.hasStroke = !1;
                    j = !0
                }
                this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)/.test(c) &&
                (m || (this.symbolAttr(a), m = !0), j = !0);
                if (l && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(c))for (e = l.length; e--;)H(l[e], c, c === "height" ? s(d - (l[e].cutHeight || 0), 0) : d);
                if ((c === "width" || c === "height") && h === "rect" && d < 0)d = 0;
                this[c] = d;
                c === "text" ? (d !== this.textStr && delete this.bBox, this.textStr = d, this.added && i.buildText(this)) : j || H(g, c, d)
            }
        ...
        h.x = Q(b || this.x || 0) + i;
        h.y = Q(c || this.y || 0) + i;
        h.width = Q((d || this.width || 0) - 2 * i);
        h.height = Q((e || this.height || 0) - 2 * i);
        h.strokeWidth = a;
        for (f in h)this[f] !== h[f] && (this[f] = g[f] = h[f]);
        return g
    }, css: function (a) {
        var b = this.element, c = this.textWidth = a && a.width && b.nodeName.toLowerCase() === "text" && E(a.width), d, e = "", f = function (a, b) {
            return"-" + b.toLowerCase()
        };
        if (a && a.color)a.fill = a.color;
        this.styles = a = u(this.styles, a);
        c && delete a.width;
        if (Fa && !da)z(this.element, a); else {
        ...
        var a = this.translateX ||
            0, b = this.translateY || 0, c = this.scaleX, d = this.scaleY, e = this.inverted, f = this.rotation;
        e && (a += this.attr("width"), b += this.attr("height"));
        a = ["translate(" + a + "," + b + ")"];
        e ? a.push("rotate(90) scale(-1,1)") : f && a.push("rotate(" + f + " " + (this.x || 0) + " " + (this.y || 0) + ")");
        (t(c) || t(d)) && a.push("scale(" + o(c, 1) + " " + o(d, 1) + ")");
        a.length && H(this.element, "transform", a.join(" "))
    }, toFront: function () {
        var a = this.element;
        ...
        c = this.element;
        var f = this.styles, g = e * La;
        d = this.textStr;
        var h;
        if (d === "" || Zb.test(d))h = d.length + "|" + f.fontSize + "|" + f.fontFamily, a = b.cache[h];
        if (!a) {
            ...
            if (b.isSVG) {
                c = a.width;
                d = a.height;
                if (Fa && f && f.fontSize === "11px" && d.toPrecision(3) === "16.9")a.height = d = 14;
                if (e)a.width = O(d * ha(g)) + O(c * ca(g)), a.height = O(d * ca(g)) + O(c * ha(g))
            }
            this.bBox = a;
            h && (b.cache[h] = a)
        }
        ...
        if (g)c.handleZ = !0, g = E(g);
        if (c.handleZ)for (c = 0; c < e.length; c++)if (a = e[c], b = H(a, "zIndex"), a !== f && (E(b) > g || !t(g) && t(b))) {
            d.insertBefore(f, a);
            h = !0;
            break
        }
        ...
        b.onclick =
            b.onmouseout = b.onmouseover = b.onmousemove = b.point = null;
        eb(a);
        ...
        if (a) {
            ...
            for (e = 1; e <= i; e++) {
                f = g.cloneNode(0);
                h = i * 2 + 1 - 2 * e;
                H(f, {isShadow: "true", stroke: a.color || "black", "stroke-opacity": j * e, "stroke-width": h, transform: "translate" + k, fill: ba});
                if (c)H(f, "height", s(H(f, "height") - h, 0)), f.cutHeight = h;
    ...
    sa.prototype = {Element: xa, init: function (a, b, c, d) {
        var e = location, f, g;
        f = this.createElement("svg").attr({version: "1.1"});
        g = f.element;
        a.appendChild(g);
        a.innerHTML.indexOf("xmlns") === -1 && H(g, "xmlns", Ma);
        this.isSVG = !0;
        this.box = g;
        this.boxWrapper = f;
        this.alignedObjects = [];
        this.url = (bb || mb) && F.getElementsByTagName("base").length ? e.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
        this.createElement("desc").add().element.appendChild(F.createTextNode("Created with Highstock 1.3.9"));
        ...
        if (bb && a.getBoundingClientRect)this.subPixelFix = b = function () {
            ...
            z(a, {left: Va(h.left) - h.left + "px", top: Va(h.top) - h.top + "px"})
        }, b(), A(V, "resize", b)
    }, isHidden: function () {
        ...
        for (var b = a.element, c = this, d = c.forExport, e = o(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), f = b.childNodes, g = /style="([^"]+)"/, h = /href="(http[^"]+)"/,
                 i = H(b, "x"), j = a.styles, k = a.textWidth, l = j && j.lineHeight, m = f.length, p = function (a) {
        ...
        q(e, function (e, f) {
            ...
            q(l, function (e) {
                if (e !== "" || l.length === 1) {
                    var n = {}, o = F.createElementNS(Ma, "tspan"), q;
                    g.test(e) && (q = e.match(g)[1].replace(/(;| |^)color([ :])/,
                        "$1fill$2"), H(o, "style", q));
                    h.test(e) && !d && (H(o, "onclick", 'location.href="' + e.match(h)[1] + '"'), z(o, {cursor: "pointer"}));
                    e = (e.replace(/<(.|\n)*?>/g, "") || " ").replace(/&lt;/g, "<").replace(/&gt;/g, ">");
                    if (e !== " " && (o.appendChild(F.createTextNode(e)), m ? n.dx = 0 : n.x = i, H(o, n), !m && f && (!da && d && z(o, {display: "block"}), H(o, "dy", p(o), mb && o.offsetHeight)), b.appendChild(o), m++, k))for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), n = e.length > 1 && j.whiteSpace !== "nowrap", r, s, v = a._clipHeight, t = [], u = p(), fa = 1; n && (e.length ||
        ...
        var j = this.label(a, b, c, i,
            null, null, null, null, "button"), k = 0, l, m, p, n, $, o, a = {x1: 0, y1: 0, x2: 0, y2: 1}, e = w({"stroke-width": 1, stroke: "#CCCCCC", fill: {linearGradient: a, stops: [
            [0, "#FEFEFE"],
            [1, "#F6F6F6"]
        ...
        delete h.style;
        A(j.element,
            Fa ? "mouseover" : "mouseenter", function () {
                k !== 3 && j.attr(f).css(n)
            });
        ...
        return e.attr(aa(a) ? a : e.crisp(f, a, b, s(c, 0), s(d, 0)))
        ...
        if (h)g = this.path(h), u(g, {symbolName: a, x: b, y: c, width: d, height: e}), f && u(g, f); else if (i.test(a))k = function (a, b) {
            a.element && (a.attr({width: b[0], height: b[1]}), a.alignByTranslate || a.translate(v((d - b[0]) / 2), v((e - b[1]) / 2)))
        }, j = a.match(i)[1], a = Sb[j], g = this.image(j).attr({x: b, y: c}), g.isImg = !0, a ? k(g, a) : (g.attr({width: 0, height: 0}), Z("img", {onload: function () {
        ...
        var f = e.start, c = e.r || c || d, g = e.end - 0.001,
            d = e.innerR, h = e.open, i = ca(f), j = ha(f), k = ca(g), g = ha(g), e = e.end - f < Ka ? 0 : 1;
        return["M", a + c * i, b + c * j, "A", c, c, 0, e, 1, a + c * k, b + c * g, h ? "M" : "L", a + d * k, b + d * g, "A", d, d, 0, e, 0, a + d * i, b + d * j, h ? "" : "Z"]
    }}, clipRect: function (a, b, c, d) {
        var e = "highcharts-" + Db++, f = this.createElement("clipPath").attr({id: e}).add(this.defs), a = this.rect(a, b, c, d, 0).add(f);
        a.id = e;
        a.clipPath = f;
        return a
        ...
        if (g) {
            ...
            j = a.stops;
            b = b.radialReference;
            Pa(c) && (a[g] = c = {x1: c[0], y1: c[1], x2: c[2], y2: c[3], gradientUnits: "userSpaceOnUse"});
            g === "radialGradient" && b && !t(c.gradientUnits) && (c = w(c, {cx: b[0] - b[2] / 2 + c.cx * b[2], cy: b[1] - b[2] / 2 + c.cy * b[2], r: c.r * b[2], gradientUnits: "userSpaceOnUse"}));
            for (m in c)m !== "id" && p.push(m, c[m]);
            for (m in j)p.push(j[m]);
            p = p.join(",");
            h[p] ? a = h[p].id : (c.id = a = "highcharts-" + Db++, h[p] = i = d.createElement(g).attr(c).add(d.defs), i.stops = [], q(j, function (a) {
        ...
        var e = L.chart.style, f = ka || !da && this.forExport;
        ...
        var a = E(a || 11), a = a < 24 ? a + 4 : v(a * 1.2), b = v(a * 0.8);
        return{h: a, b: b}
    }, label: function (a, b, c, d, e, f, g, h, i) {
        function j() {
            var a, b;
            a = o.element.style;
            x = (Ca === void 0 || I === void 0 || n.styles.textAlign) && o.getBBox();
            n.width = (Ca || x.width || 0) + 2 * s + qb;
            n.height = (I || x.height || 0) + 2 * s;
            fa = s + p.fontMetrics(a && a.fontSize).b;
            if (Hb) {
                if (!J)a = v(-pb * s), b = h ? -fa : 0, n.box = J = d ? p.symbol(d, a, b, n.width, n.height, P) : p.rect(a, b, n.width, n.height, 0, P[Ub]), J.add(n);
                J.isImg ||
                J.attr(w({width: n.width, height: n.height}, P));
                P = null
            }
        }

        function k() {
            var a = n.styles, a = a && a.textAlign, b = qb + s * (1 - pb), c;
            c = h ? 0 : fa;
            if (t(Ca) && (a === "center" || a === "right"))b += {center: 0.5, right: 1}[a] * (Ca - x.width);
        ...
        function m() {
            ...
            J && t(e) && n.attr({anchorX: e, anchorY: f})
        }

        var p = this, n = p.g(i), o = p.text("", 0, 0, g).attr({zIndex: 1}), J, x, pb = 0, s = 3, qb = 0, Ca, I, Gb, G, C = 0, P = {}, fa, g = n.attrSetters, Hb;
        A(n, "add", m);
        g.width = function (a) {
            Ca = a;
            return!1
        ...
        g.align = function (a) {
            pb = {left: 0, center: 0.5, right: 1}[a];
            return!1
        };
        g.text = function (a, b) {
            o.attr(b, a);
        ...
        return u(n, {css: function (a) {
            ...
            o && (o = o.destroy());
            J && (J = J.destroy());
            xa.prototype.destroy.call(n);
            n = p = j = k = l = m = null
        }})
    }};
    Za = sa;
    u(xa.prototype, {htmlCss: function (a) {
        var b = this.element;
        ...
        if (this.added) {
            ...
            if (b.tagName === "SPAN") {
                var j =
                    this.rotation, k, l = E(this.textWidth), m = [j, g, b.innerHTML, this.textWidth].join(",");
                if (m !== this.cTT) {
                    k = a.fontMetrics(b.style.fontSize).b;
                    t(j) && this.setSpanRotation(j, h, k);
                    i = o(this.elemWidth, b.offsetWidth);
                    if (i > l && /[ \-]/.test(b.textContent || b.innerText))z(b, {width: l + "px", display: "block", whiteSpace: "normal"}), i = l;
                    this.getSpanCorrection(i, k, h, j, g)
                }
                z(b, {left: e + (this.xCorr || 0) + "px", top: f + (this.yCorr || 0) + "px"});
        ...
        var d =
        {}, e = Fa ? "-ms-transform" : mb ? "-webkit-transform" : bb ? "MozTransform" : Rb ? "-o-transform" : "";
        d[e] = d.transform = "rotate(" + a + "deg)";
        d[e + (bb ? "Origin" : "-origin")] = b * 100 + "% " + c + "px";
        z(this.element, d)
    }, getSpanCorrection: function (a, b, c) {
        this.xCorr = -a * c;
        this.yCorr = -b
    }});
    u(sa.prototype, {html: function (a, b, c) {
        ...
        e.attr({text: a, x: v(b), y: v(c)}).css({position: "absolute", whiteSpace: "nowrap", fontFamily: d.fontFamily, fontSize: d.fontSize});
        e.css = e.htmlCss;
            ...
            if (this.parentGroup = a) {
                if (b = a.div, !b) {
                    ...
                    q(d.reverse(), function (a) {
                        var d;
                        b = a.div = a.div || Z(Ta, {className: H(a.element, "class")}, {position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px"}, b || c);
                        d = b.style;
    ...
    var rb, qa;
    if (!da && !ka)Highcharts.VMLElement = qa = {init: function (a, b) {
        ...
        N(this, "add");
        return this
    }, updateTransform: xa.prototype.htmlUpdateTransform, setSpanRotation: function () {
        var a = this.rotation, b = ca(a * La), c = ha(a * La);
        z(this.element, {filter: a ?
            ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : ba})
    }, getSpanCorrection: function (a, b, c, d, e) {
        var f = d ? ca(d * La) : 1, g = d ? ha(d * La) : 0, h = o(this.elemHeight, this.element.offsetHeight), i;
        this.xCorr = f < 0 && -a;
        this.yCorr = g < 0 && -h;
        i = f * g < 0;
        this.xCorr += g * b * (i ? 1 - c : c);
        this.yCorr -= f * b * (d ? i ? c : 1 - c : 1);
        e && e !== "left" && (this.xCorr -= a * c * (f < 0 ? -1 : 1), d && (this.yCorr -= h * c * (g < 0 ? -1 : 1)), z(this.element, {textAlign: e}))
    }, pathToVML: function (a) {
        for (var b = a.length,
                 c = []; b--;)if (ua(a[b]))c[b] = v(a[b] * 10) - 5; else if (a[b] === "Z")c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at"))c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1);
        return c.join(" ") || "x"
    }, attr: function (a, b) {
        var c, d, e, f = this.element || {}, g = f.style, h = f.nodeName, i = this.renderer, j = this.symbolName, k, l = this.shadows, m, p = this.attrSetters, n = this;
        ma(a) && t(b) && (c = a, a = {}, a[c] = b);
        if (ma(a))c = a, n = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c]; else for (c in a)if (d =
            ...
            } else if (c === "opacity")m = !0; else if (h === "shape" && c === "rotation")this[c] = f.style[c] = d, f.style.left = -v(ha(d * La) + 1) + "px", f.style.top = v(ca(d * La)) + "px"; else if (c === "translateX" || c === "translateY" || c === "rotation")this[c] = d, this.updateTransform(), m = !0;
            m || (lb ? f[c] = d : H(f, c, d))
        }
        return n
    }, clip: function (a) {
        var b = this, c;
        a ? (c = a.members, oa(c, b), c.push(b), b.destroyClip =
            function () {
                oa(c, b)
            }, a = a.getCSS(b)) : (b.destroyClip && b.destroyClip(), a = {clip: lb ? "inherit" : "rect(auto)"});
        return b.css(a)
    }, css: xa.prototype.htmlCss, safeRemoveChild: function (a) {
        a.parentNode && Sa(a)
    }, destroy: function () {
        this.destroyClip && this.destroyClip();
        return xa.prototype.destroy.apply(this)
    }, on: function (a, b) {
        ...
        var c, a = a.split(/[ ,]/);
        c = a.length;
        if (c === 9 || c === 11)a[c - 4] = a[c - 2] = E(a[c - 2]) - 10 * b;
        return a.join(" ")
    }, shadow: function (a, b, c) {
        var d = [], e, f = this.element, g = this.renderer, h, i = f.style, j, k = f.path, l, m, p, n;
        ...
        if (a) {
            ...
            for (e = 1; e <= 3; e++) {
                ...
                h = Z(g.prepVML(j), null, {left: E(i.left) + o(a.offsetX, 1), top: E(i.top) + o(a.offsetY, 1)});
                if (c)h.cutOff = l + 1;
                j = ['<stroke color="',
                    a.color || "black", '" opacity="', n * e, '"/>'];
        ...
        return this
    }}, qa = ea(xa, qa), qa = {Element: qa, isIE8: za.indexOf("MSIE 8.0") > -1, init: function (a, b, c) {
        var d, e;
        this.alignedObjects = [];
        ...
        return u(e, {members: [], left: (f ? a.x : a) + 1, top: (f ? a.y : b) + 1, width: (f ? a.width : c) - 1, height: (f ? a.height : d) - 1, getCSS: function (a) {
            var b =
                a.element, c = b.nodeName, a = a.inverted, d = this.top - (c === "shape" ? b.offsetTop : 0), e = this.left, b = e + this.width, f = d + this.height, d = {clip: "rect(" + v(a ? e : d) + "px," + v(a ? f : b) + "px," + v(a ? b : f) + "px," + v(a ? d : e) + "px)"};
        ...
        var e = this, f, g = /^rgba/, h, i, j = ba;
        a && a.linearGradient ? i = "gradient" : a && a.radialGradient && (i = "pattern");
        if (i) {
            var k, l, m = a.linearGradient || a.radialGradient,
                p, n, o, J, x, s = "", a = a.stops, r, t = [], v = function () {
                    h = ['<fill colors="' + t.join(",") + '" opacity="', o, '" o:opacity2="', n, '" type="', i, '" ', s, 'focus="100%" method="any" />'];
            ...
            r[0] < 1 && a.push([1, r[1]]);
            q(a, function (a, b) {
                g.test(a[1]) ? (f = Ba(a[1]), k = f.get("rgb"), l = f.get("a")) : (k = a[1], l = 1);
                t.push(a[0] * 100 + "% " + k);
                b ? (o = l, J = k) : (n = l, x = k)
            });
            if (c === "fill")if (i === "gradient")c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, p = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, s = 'angle="' +
                (90 - T.atan((m - a) / (p - c)) * 180 / Ka) + '"', v(); else {
                var j = m.r, u = j * 2, w = j * 2, G = m.cx, C = m.cy, P = b.radialReference, fa, j = function () {
                    P && (fa = d.getBBox(), G += (P[0] - fa.x) / fa.width - 0.5, C += (P[1] - fa.y) / fa.height - 0.5, u *= P[2] / fa.width, w *= P[2] / fa.height);
                    s = 'src="' + L.global.VMLRadialGradientURL + '" size="' + u + "," + w + '" origin="0.5,0.5" position="' + G + "," + C + '" color2="' + x + '" ';
                    v()
                };
                d.added ? j() : A(d, "add", j);
                j = J
        ...
        g.r = aa(a) ? a.r : e;
        return g.attr(aa(a) ? a : g.crisp(f, a, b, s(c, 0), s(d, 0)))
    }, invertChild: function (a, b) {
        var c = b.style;
        z(a, {flip: "x", left: E(c.width) - 1, top: E(c.height) - 1, rotation: -90})
    }, symbols: {arc: function (a, b, c, d, e) {
        var f = e.start, g = e.end, h = e.r || c || d, c = e.innerR, d = ca(f), i = ha(f), j = ca(g), k = ha(g);
        if (g - f === 0)return["x"];
        ...
        var f = a + c, g = b + d, h;
        !t(e) || !e.r ? f = sa.prototype.symbols.square.apply(0, arguments) : (h = y(e.r, c, d), f = ["M", a + h, b, "L", f - h, b, "wa", f - 2 * h, b, f, b + 2 * h, f - h, b, f, b + h, "L", f, g - h, "wa", f - 2 * h, g - 2 * h, f, g, f, g - h, f - h, g, "L", a + h, g, "wa", a, g - 2 * h, a + 2 * h, g, a + h, g, a, g - h, "L", a, b + h, "wa", a, b, a + 2 * h, b + 2 * h, a, b + h, a + h, b, "x", "e"]);
        return f
    }}}, Highcharts.VMLRenderer = rb = function () {
        this.init.apply(this, arguments)
    }, rb.prototype =
        w(sa.prototype, qa), Za = rb;
    ...
    var Vb;
    if (ka)Highcharts.CanVGRenderer = qa = function () {
    ...
    Ya.prototype = {addLabel: function () {
        var a =
            this.axis, b = a.options, c = a.chart, d = a.horiz, e = a.categories, f = a.names, g = this.pos, h = b.labels, i = a.tickPositions, d = d && e && !h.step && !h.staggerLines && !h.rotation && c.plotWidth / i.length || !d && (c.margin[3] || c.chartWidth * 0.33), j = g === i[0], k = g === i[i.length - 1], l, f = e ? o(e[g], f[g], g) : g, e = this.label, m = i.info;
        a.isDatetimeAxis && m && (l = b.dateTimeLabelFormats[m.higherRanks[g] || m.unitName]);
        this.isFirst = j;
        this.isLast = k;
        b = a.labelFormatter.call({axis: a, chart: c, isFirst: j, isLast: k, dateTimeLabelFormat: l, value: a.isLog ? ga(na(f)) :
            f});
        g = d && {width: s(1, v(d - 2 * (h.padding || 10))) + "px"};
        g = u(g, h.style);
        if (t(e))e && e.attr({text: b}).css(g); else {
            l = {align: a.labelAlign};
            if (ua(h.rotation))l.rotation = h.rotation;
        ...
        var a = this.label.getBBox(), b = this.axis, c = b.horiz, d = b.options.labels,
            a = c ? a.width : a.height, b = c ? a * {left: 0, center: 0.5, right: 1}[b.labelAlign] - d.x : a;
        return[-b, a - b]
    }, handleOverflow: function (a, b) {
        var x;
        var c = !0, d = this.axis, e = this.isFirst, f = this.isLast, g = d.horiz ? b.x : b.y, h = d.reversed, i = d.tickPositions, j = this.getLabelSides(), k = j[0], j = j[1], l = d.pos, m = l + d.len, p = this.label.line || 0, n = d.labelEdge, o = d.justifyLabels && (e || f);
        n[p] === r || g + k > n[p] ? n[p] = g + j : o || (c = !1);
        if (o)x = (d = d.ticks[i[a + (e ? 1 : -1)]]) && d.label.xy && d.label.xy.x + d.getLabelSides()[e ? 0 : 1], i = x, e && !h || f && h ? g + k < l && (g = l - k, d && g + j >
            i && (c = !1)) : g + j > m && (g = m - j, d && g + k < i && (c = !1)), b.x = g;
        return c
        ...
        p && i.side === 2 && (b -= m - m * ca(p * La));
        !t(e.y) && !p && (b += m - c.getBBox().height / 2);
        ...
        var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type, i = this.label, j = this.pos, k = e.labels, l = this.gridLine, m = h ? h + "Grid" : "grid", p = h ? h + "Tick" : "tick", n = e[m + "LineWidth"],
            q = e[m + "LineColor"], J = e[m + "LineDashStyle"], x = e[p + "Length"], m = e[p + "Width"] || 0, s = e[p + "Color"], t = e[p + "Position"], p = this.mark, v = k.step, u = !0, I = d.tickmarkOffset, w = this.getPosition(g, j, I, b), G = w.x, w = w.y, C = g && G === d.pos + d.len || !g && w === d.pos ? -1 : 1;
        this.isActive = !0;
        if (n) {
            j = d.getPlotLinePath(j + I, n * C, b, !0);
            if (l === r) {
                l = {stroke: q, "stroke-width": n};
                if (J)l.dashstyle = J;
                if (!h)l.zIndex = 1;
                if (b)l.opacity = 0;
                this.gridLine = l = n ? f.path(j).attr(l).add(d.gridGroup) : null
            }
            if (!b && l && j)l[this.isNew ? "attr" : "animate"]({d: j, opacity: c})
        }
        if (m &&
            x)t === "inside" && (x = -x), d.opposite && (x = -x), h = this.getMarkPath(G, w, x, m * C, g, f), p ? p.animate({d: h, opacity: c}) : this.mark = f.path(h).attr({stroke: s, "stroke-width": m, opacity: c}).add(d.axisGroup);
        if (i && !isNaN(G))i.xy = w = this.getLabelPosition(G, w, i, g, k, I, a, v), this.isFirst && !this.isLast && !o(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !o(e.showLastLabel, 1) ? u = !1 : !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && (u = this.handleOverflow(a, w)), v && a % v && (u = !1), u && !isNaN(w.y) ? (w.opacity = c, i[this.isNew ? "attr" : "animate"](w),
    ...
    Qb.prototype = {destroy: function () {
        ...
        var b = this.options, c = b.format, c = c ? Ha(c, this) : b.formatter.call(this);
        ...
        var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative, g =
            c.translate(this.percent ? 100 : this.total, 0, 0, 0, 1), c = c.translate(0), c = O(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight, f = {x: e ? f ? g : g - c : h, y: e ? i - h - b : f ? i - g - c : i - g, width: e ? c : b, height: e ? b : c};
        if (e = this.label)e.align(this.alignOptions, null, f), f = e.alignAttr, e.attr({visibility: this.options.crop === !1 || d.isInsidePlot(f.x, f.y) ? da ? "inherit" : "visible" : "hidden"})
    }};
    var Ib = function (a, b) {
        this.axis = a;
    ...
    Ib.prototype = {render: function () {
        var a = this, b = a.axis, c = b.horiz, d = (b.pointRange ||
            0) / 2, e = a.options, f = e.label, g = a.label, h = e.width, i = e.to, j = e.from, k = t(j) && t(i), l = e.value, m = e.dashStyle, p = a.svgElem, n = [], q, J = e.color, x = e.zIndex, r = e.events, v = b.chart.renderer;
        b.isLog && (j = Ea(j), i = Ea(i), l = Ea(l));
        if (h) {
        ...
        if (t(x))d.zIndex = x;
        if (p)if (n)p.animate({d: n}, null, p.onGetPath);
        else {
            if (p.hide(), p.onGetPath = function () {
                p.show()
            }, g)a.label = g = g.destroy()
        } else if (n && n.length && (a.svgElem = p = v.path(n).attr(d).add(), r))for (q in e = function (b) {
            p.on(b, function (c) {
                r[b].apply(a, [c])
            })
        }, r)e(q);
        if (f && t(f.text) && n && n.length && b.width > 0 && b.height > 0) {
            ...
            if (!g)a.label = g = v.text(f.text, 0, 0, f.useHTML).attr({align: f.textAlign || f.align, rotation: f.rotation, zIndex: x}).css(f.style).add();
            b = [n[1],
                n[4], o(n[6], n[1])];
            n = [n[2], n[5], o(n[7], n[2])];
            c = Ra(b);
            k = Ra(n);
            g.align(f, !1, {x: c, y: k, width: va(b) - c, height: va(n) - k});
            g.show()
        } else g && g.hide();
        return a
    }, destroy: function () {
    ...
    W.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M", hour: "%H:%M", day: "%e. %b", week: "%e. %b", month: "%b '%y", year: "%Y"}, endOnTick: !1, gridLineColor: "#C0C0C0", labels: K, lineColor: "#C0D0E0", lineWidth: 1, minPadding: 0.01,
        ...
        startOnTick: !0, tickWidth: 0, title: {rotation: 270, text: "Values"}, stackLabels: {enabled: !1, formatter: function () {
            return Ga(this.total, -1)
        }, style: K.style}}, defaultLeftAxisOptions: {labels: {x: -8, y: null}, title: {rotation: 270}}, defaultRightAxisOptions: {labels: {x: 8, y: null}, title: {rotation: 90}}, defaultBottomAxisOptions: {labels: {x: 0, y: 14}, title: {rotation: 0}}, defaultTopAxisOptions: {labels: {x: 0, y: -5}, title: {rotation: 0}}, init: function (a, b) {
        var c = b.isX;
        ...
        this.tickmarkOffset = this.categories &&
            d.tickmarkPlacement === "between" ? 0.5 : 0;
        this.ticks = {};
        this.labelEdge = [];
        this.minorTicks = {};
        ...
        this.crosshair = o(d.crosshair, ja(a.options.tooltip.crosshairs)[c ? 0 : 1], !1);
        var f, d = this.options.events;
        Aa(this, a.axes) === -1 && (a.axes.push(this), a[this.coll].push(this));
        this.series =
            this.series || [];
        ...
        var a = this.axis,
            b = this.value, c = a.categories, d = this.dateTimeLabelFormat, e = L.lang.numericSymbols, f = e && e.length, g, h = a.options.labels.format, a = a.isLog ? b : a.tickInterval;
        if (h)g = Ha(h, this); else if (c)g = b; else if (d)g = ra(d, b); else if (f && a >= 1E3)for (; f-- && g === r;)c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Ga(b / c, -1) + e[f]);
        g === r && (g = b >= 1E4 ? Ga(b, 0) : Ga(b, -1, r, ""));
        return g
        ...
        q(a.series, function (c) {
            if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                ...
                if (a.isXAxis) {
                    ...
                    e = c.dataMax;
                    c = c.dataMin;
                    if (t(c) && t(e))a.dataMin = y(o(a.dataMin, c), c), a.dataMax = s(o(a.dataMax, e), e);
        ...
        b ? (a = a * h + i, a -= k, a = a / j + d, e && (a = this.lin2val(a))) : (e && (a = this.val2lin(a)), f === "between" && (f = 0.5), a = h * (a - d) * j + i + h * k + (ua(f) ? j * f * this.pointRange : 0));
        return a
        ...
        }), this.minRange = y(f * 5, this.dataMax - this.dataMin));
        ...
        if (this.isXAxis || h)g ? (e = g.minPointOffset, f = g.pointRangePadding) : q(this.series, function (a) {
        ...
        var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = b.options.tickPositioner, j = d.maxPadding, k = d.minPadding, l = d.tickInterval,
            m = d.minTickInterval, p = d.tickPixelInterval, n, $ = b.categories;
        h ? (b.linkedParent = c[b.coll][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = o(c.min, c.dataMin), b.max = o(c.max, c.dataMax), d.type !== b.linkedParent.options.type && pa(11, 1)) : (b.min = o(b.userMin, d.min, b.dataMin), b.max = o(b.userMax, d.max, b.dataMax));
        if (e)!a && y(b.min, o(b.dataMin, b.min)) <= 0 && pa(10, 1), b.min = ga(Ea(b.min)), b.max = ga(Ea(b.max));
        if (b.range && t(b.max))b.userMin = b.min = s(b.min, b.max - b.range), b.userMax = b.max, b.range = null;
        b.beforePadding && b.beforePadding();
        b.adjustForMinRange();
        if (!$ && !b.usePercentage && !h && t(b.min) && t(b.max) && (c = b.max - b.min)) {
        ...
        b.min === b.max || b.min === void 0 || b.max === void 0 ? b.tickInterval = 1 : h && !l && p === b.linkedParent.options.tickPixelInterval ? b.tickInterval = b.linkedParent.tickInterval : (b.tickInterval = o(l, $ ? 1 : (b.max - b.min) * p / s(b.len, p)), !t(l) && b.len < p && !this.isRadial && !$ && d.startOnTick &&
            d.endOnTick && (n = !0, b.tickInterval /= 4));
        ...
        if (!f && !e && !l)b.tickInterval = ub(b.tickInterval, null, tb(b.tickInterval), d);
        ...
        this.allowZoomOutside || (t(this.dataMin) && a <= this.dataMin && (a = r), t(this.dataMax) && b >= this.dataMax && (b = r));
        ...
        var a = this.isLog;
        return{min: a ? ga(na(this.min)) : this.min, max: a ? ga(na(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax}
    },
        getThreshold: function (a) {
            ...
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k = 0, l, m = 0, p = d.title, n = d.labels, $ = 0, J = b.axisOffset, x = b.clipOffset, v = [-1, 1, 1, -1][h], u,
                w = 1, Ca = o(n.maxStaggerLines, 5), I, y, G, C;
            ...
            if (j || a.isLinked) {
                ...
                if (a.horiz && !a.staggerLines && Ca && !n.rotation) {
                    for (u = a.reversed ? [].concat(e).reverse() : e; w < Ca;) {
                        j = [];
                        I = !1;
                        for (n = 0; n < u.length; n++)y = u[n], G = (G = f[y].label && f[y].label.getBBox()) ? G.width : 0, C = n % w, G && (y = a.translate(y), j[C] !== r && y < j[C] && (I = !0), j[C] = y + G);
                        if (I)w++; else break
                    }
            ...
            a.offset = v * o(d.offset, J[h]);
            a.axisTitleMargin = o(l, $ + m + (h !== 2 && $ && v * d.labels[g ? "y" : "x"]));
            J[h] = s(J[h], a.axisTitleMargin + k + v * a.offset);
            x[i] = s(x[i], Q(d.lineWidth / 2) * 2)
            ...
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c, g = this.opposite, h = this.offset, i = E(e.style.fontSize || 12), d = {low: f + (a ? 0 : d), middle: f + d / 2, high: f + (a ? d : 0)}[e.align], b = (a ? c + this.height : b) +
                (a ? 1 : -1) * (g ? -1 : 1) * this.axisTitleMargin + (this.side === 2 ? i : 0);
            ...
            if (s)b = a.getLinePath(s), a.axisLine ? a.axisLine.animate({d: b}) : a.axisLine = e.path(b).attr({stroke: f.lineColor, "stroke-width": s, zIndex: 7}).add(a.axisGroup), a.axisLine[w ? "show" : "hide"]();
            if (k && w)k[k.isNew ? "attr" : "animate"](a.getTitlePosition()), k.isNew = !1;
            if (o && o.enabled) {
                var C, P, f = a.stackTotalGroup;
                if (!f)a.stackTotalGroup =
                    f = e.g("stack-labels").attr({visibility: "visible", zIndex: 6}).add();
                f.translate(d.plotLeft, d.plotTop);
                for (C in l)for (P in e = l[C], e)e[P].render(f)
            }
            a.isDirty = !1
        }, redraw: function () {
    ...
    u(W.prototype, {getPlotBandPath: function (a, b) {
        ...
        var c = (new Ib(this, a)).render(), d = this.userOptions;
    ...
    W.prototype.getTimeTicks = function (a, b, c, d) {
        var e = [], f = {}, g = L.global.useUTC, h, i = new Date(b - Ja), j = a.unitRange, k = a.count;
        if (t(b)) {
            j >= B.second && (i.setMilliseconds(0), i.setSeconds(j >= B.minute ?
                0 : k * Q(i.getSeconds() / k)));
            if (j >= B.minute)i[Mb](j >= B.hour ? 0 : k * Q(i[wb]() / k));
            if (j >= B.hour)i[Nb](j >= B.day ? 0 : k * Q(i[xb]() / k));
            if (j >= B.day)i[zb](j >= B.month ? 1 : k * Q(i[Ua]() / k));
            j >= B.month && (i[Ob](j >= B.year ? 0 : k * Q(i[jb]() / k)), h = i[kb]());
            j >= B.year && (h -= h % k, i[Pb](h));
            if (j === B.week)i[zb](i[Ua]() - i[yb]() + o(d, 1));
            b = 1;
            Ja && (i = new Date(i.getTime() + Ja));
            h = i[kb]();
            for (var d = i.getTime(), l = i[jb](), m = i[Ua](), p = g ? Ja : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;)e.push(d), j === B.year ? d = ib(h + b * k, 0) : j === B.month ? d = ib(h, l + b * k) :
                !g && (j === B.day || j === B.week) ? d = ib(h, l, m + b * k * (j === B.day ? 1 : 7)) : d += j * k, b++;
            e.push(d);
            q(Fb(e, function (a) {
    ...
    W.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5)a = v(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = Q(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
            i =
                e.length;
            for (h = 0; h < i && !l; h++)j = Ea(na(f) * e[h]), j > b && (!d || k <= c) && g.push(k), k > c && (l = !0), k = j
        } else if (b = na(b), c = na(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = o(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = ub(a, null, tb(a)), g = Na(this.getLinearTickPositions(a, b, c), Ea), !d)this._minorAutoInterval = a / 5;
    ...
    Ab.prototype = {init: function (a, b) {
        ...
        u(f, {x: g ? (2 * f.x + a) / 3 : a, y: g ? (f.y + b) / 2 : b, anchorX: g ? (2 * f.anchorX + c) / 3 : c, anchorY: g ? (f.anchorY + d) / 2 : d});
        e.label.attr(f);
        ...
        var d = this.chart, e = d.plotLeft,
            f = d.plotTop, g = d.plotWidth, h = d.plotHeight, i = o(this.options.distance, 12), j = c.plotX, c = c.plotY, d = j + e + (d.inverted ? i : -a - i), k = c - b + f + 15, l;
        d < 7 && (d = e + s(j, 0) + i);
        ...
        i = i.call(h, this);
        h = a.series;
        i === !1 ? this.hide() : (this.isHidden && (eb(d), d.attr("opacity", 1).show()), d.attr({text: i}), k = e.borderColor || a.color || h.color || "#606060", d.attr({stroke: k}), this.updatePosition({plotX: f, plotY: g}), this.isHidden = !1);
    ...
    $a.prototype = {init: function (a, b) {
        ...
        this.pinchDown = [];
        this.lastValidTouch = {};
        if (b.tooltip.enabled)a.tooltip = new Ab(a, b.tooltip);
        this.setDOMEvents()
        ...
        return u(a, {chartX: v(c), chartY: v(d)})
        ...
        if (e && b.options.tooltip.shared && (!i || !i.noSharedTooltip)) {
            g = [];
            j = d.length;
            for (k = 0; k < j; k++)if (d[k].visible && d[k].options.enableMouseTracking !== !1 && !d[k].noSharedTooltip && d[k].tooltipPoints.length && (f = d[k].tooltipPoints[m]) && f.series)f._dist = O(m - f.clientX), l = y(l, f._dist), g.push(f);
            for (j = g.length; j--;)g[j]._dist >
                l && g.splice(j, 1);
        ...
        }, A(F, "mousemove", b._onDocumentMouseMove);
        q(c.axes, function (b) {
        ...
        (a = a && e && f) && ja(f)[0].plotX === r && (a = !1);
        if (a)e.refresh(f), d && d.setState(d.state, !0); else {
            if (d)d.onMouseOut();
            if (c)c.onMouseOut();
            e && e.hide();
            if (this._onDocumentMouseMove)X(F, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null;
            q(b.axes, function (a) {
                a.hideCrosshair()
            });
            this.hoverX = null
        ...
        var i = this.chart, j = a ? "x" : "y", k = a ? "X" : "Y", l = "chart" + k, m = a ? "width" : "height", p = i["plot" + (a ? "Left" : "Top")], n, o, q = h || 1, x = i.inverted, s = i.bounds[a ? "h" : "v"], r = b.length === 1, v = b[0][l], t = c[0][l], u = !r && b[1][l],
            w = !r && c[1][l], y, c = function () {
                !r && O(v - u) > 20 && (q = h || O(t - w) / O(v - u));
                o = (p - t) / q + v;
                n = i["plot" + (a ? "Width" : "Height")] / q
            };
        c();
        b = o;
        b < s.min ? (b = s.min, y = !0) : b + n > s.max && (b = s.max - n, y = !0);
        y ? (t -= 0.8 * (t - g[j][0]), r || (w -= 0.8 * (w - g[j][1])), c()) : g[j] = [t, w];
        x || (f[j] = o - p, f[m] = n);
        f = x ? 1 / q : q;
        e[m] = n;
        e[j] = b;
        d[x ? a ? "scaleY" : "scaleX" : "scale" + k] = q;
        d["translate" + k] = f * p + (t - f * v)
    }, pinch: function (a) {
        var b = this, c = b.chart, d = b.pinchDown, e = c.tooltip && c.tooltip.options.followTouchMove, f = a.touches, g = f.length, h = b.lastValidTouch, i = b.zoomHor ||
            b.pinchHor, j = b.zoomVert || b.pinchVert, k = i || j, l = b.selectionMarker, m = {}, p = g === 1 && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || c.runChartClick), n = {};
        ...
        if (a.type === "touchstart")q(f, function (a, b) {
            ...
            if (a.zoomEnabled) {
                var b = c.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, e = a.toPixels(a.dataMin),
                    f = a.toPixels(a.dataMax), g = y(e, f), e = s(e, f);
                b.min = y(a.pos, g - d);
                b.max = s(a.pos + a.len, e + d)
            }
        }); else if (d.length) {
            if (!l)b.selectionMarker = l = u({destroy: la}, c.plotBox);
            b.pinchTranslate(i, j, d, f, m, l, n, h);
            b.hasPinched = k;
            b.scaleGroups(m, n);
        ...
        var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY,
            f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, j = b.plotWidth, k = b.plotHeight, l, m = this.mouseDownX, p = this.mouseDownY;
        d < h ? d = h : d > h + j && (d = h + j);
        e < i ? e = i : e > i + k && (e = i + k);
        ...
        if (this.hasDragged > 10) {
            ...
            this.selectionMarker &&
                f && (d -= m, this.selectionMarker.attr({width: O(d), x: (d > 0 ? 0 : d) + m}));
            this.selectionMarker && g && (d = e - p, this.selectionMarker.attr({height: O(d), y: (d > 0 ? 0 : d) + p}));
            ...
            if (this.hasDragged || c)q(b.axes, function (a) {
                if (a.zoomEnabled) {
                    var b = a.horiz, c = a.toValue(b ? f : g), b = a.toValue(b ? f + e.width :
                        g + e.height);
                    !isNaN(c) && !isNaN(b) && (d[a.coll].push({axis: a, min: y(c, b), max: s(c, b)}), h = !0)
                }
        ...
        onDocumentMouseMove: function (a) {
            ...
            var b = this.chart, c = b.hoverPoint, d = b.plotLeft, e = b.plotTop,
                f = b.inverted, g, h, i, a = this.normalize(a);
            a.cancelBubble = !0;
            if (!b.cancelClick)c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, u(c, {pageX: g.left + d + (f ? b.plotWidth - i : h), pageY: g.top + e + (f ? b.plotHeight - h : i)}), N(c.series, "click", u(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (u(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && N(b, "click", a))
        }, onContainerTouchStart: function (a) {
            var b = this.chart;
            a.touches.length === 1 ? (a = this.normalize(a), b.isInsidePlot(a.chartX -
            ...
            db && c.push([b, "ontouchstart", "onContainerTouchStart"], [b, "ontouchmove", "onContainerTouchMove"], [F, "touchend", "onDocumentTouchEnd"]);
            q(c, function (b) {
                a["_" + b[2]] = function (c) {
                    a[b[2]](c)
                };
            ...
            var a = this;
            q(a._events, function (b) {
                b[1].indexOf("on") === 0 ? b[0][b[1]] = null : X(b[0], b[1], a["_" + b[2]])
            });
            delete a._events;
            clearInterval(a.tooltipTimeout)
        }};
    var fb = Highcharts.TrackerMixin = {drawTrackerPoint: function () {
        var a =
        ...
        for (m = 0; m < k.length; m++)e = k[m], d.push("M", e.plotX - i, e.plotY, "L",
            e.plotX + i, e.plotY);
    ...
    if (V.PointerEvent || V.MSPointerEvent) {
        ...
        $a.prototype.getWebkitTouches = function () {
            ...
            for (a in ta)ta.hasOwnProperty(a) && b.push({pageX: ta[a].pageX, pageY: ta[a].pageY, target: ta[a].target});
            return b
        };
        ...
        U($a.prototype, "setDOMEvents", function (a) {
            ...
            q([
                ...
                [this.chart.container, "PointerMove", "touchmove", "onContainerTouchMove", function (a) {
                    ta[a.pointerId] = {pageX: a.pageX, pageY: a.pageY};
                    if (!ta[a.pointerId].target)ta[a.pointerId].target = a.currentTarget
                }],
                ...
                A(a[0], window.PointerEvent ? a[1].toLowerCase() : "MS" + a[1], function (d) {
                    d = d.originalEvent;
                    if (d.pointerType === "touch" || d.pointerType === d.MSPOINTER_TYPE_TOUCH)a[4](d), b[a[3]]({type: a[2], target: d.currentTarget,
    ...
    Jb.prototype = {init: function (a, b) {
        ...
        this.options = b;
        if (b.enabled)c.baseline = E(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = w(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.symbolWidth = o(b.symbolWidth, 16), c.pages = [], c.render(),
            A(c.chart, "endResize", function () {
        ...
        e && e.attr({stroke: h});
        if (f) {
            if (g && f.isMarker)for (j in g = a.convertAttribs(g), g)d = g[j], d !== r && (i[j] = d);
            f.attr(i)
        }
        ...
        if (b)c = b.translateY, q(this.allItems,
            function (e) {
                var f = e.checkbox, g;
                f && (g = c + f.y + (a || 0) + 3, z(f, {left: b.translateX + e.legendItemWidth + f.x - 20 + "px", top: g + "px", display: g > c - 6 && g < c + d - 6 ? "" : ba}))
            })
        ...
        renderItem: function (a) {
            var C;
            var b = this, c = b.chart, d = c.renderer, e = b.options, f = e.layout === "horizontal", g = b.symbolWidth, h = e.symbolPadding, i = b.itemStyle, j = b.itemHiddenStyle, k = b.padding, l = f ? o(e.itemDistance, 8) : 0, m = !e.rtl, p = e.width, n = e.itemMarginBottom || 0, q = b.itemMarginTop, J = b.initialItemX, x = a.legendItem, r = a.series && a.series.drawLegendSymbol ? a.series : a, t = r.options, t = t && t.showCheckbox, u = e.useHTML;
            if (!x && (a.legendGroup = d.g("legend-item").attr({zIndex: 1}).add(b.scrollGroup), r.drawLegendSymbol(b, a), a.legendItem =
                x = d.text(e.labelFormat ? Ha(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline, u).css(w(a.visible ? i : j)).attr({align: m ? "left" : "right", zIndex: 2}).add(a.legendGroup), (u ? x : a.legendGroup).on("mouseover",function () {
                a.setState("hover");
                x.css(b.options.itemHoverStyle)
                ...
                a.visible), t))a.checkbox = Z("input", {type: "checkbox", checked: a.selected, defaultChecked: a.selected}, e.itemCheckboxStyle, c.container), A(a.checkbox, "click", function (b) {
                N(a, "checkboxClick", {checked: b.target.checked}, function () {
                    a.select()
                })
            });
            d = x.getBBox();
            C = a.legendItemWidth = e.itemWidth || a.legendItemWidth || g + h + d.width + l + (t ? 20 : 0), e = C;
            b.itemHeight = g = v(a.legendItemHeight || d.height);
            if (f && b.itemX - J + e > (p || c.chartWidth - 2 * k - J))b.itemX = J, b.itemY += q + b.lastLineHeight + n, b.lastLineHeight = 0;
            b.maxItemWidth = s(b.maxItemWidth,
                e);
            ...
            b.offsetWidth = p || s((f ? b.itemX - J - l : e) + k, b.offsetWidth)
            ...
            if (l || m) {
                ...
                } else a.box = i = c.rect(0, 0, g, h, j.borderRadius, l || 0).attr({stroke: j.borderColor, "stroke-width": l || 0, fill: m || ba}).add(d).shadow(j.shadow), i.isNew = !0;
                i[f ? "show" : "hide"]()
            }
            a.legendWidth = g;
            a.legendHeight = h;
            ...
            var b =
                this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, j = e.navigation, k = o(j.animation, !0), l = j.arrowSize || 12, m = this.nav, p = this.pages, n, $ = this.allItems;
            ...
            if (a > f && !e.useHTML) {
                ...
                q($, function (a, b) {
                    var c = a._legendItemPos[1], d = v(a.legendItem.bBox.height),
                        e = p.length;
                    if (!e || c - p[e - 1] > h)p.push(n || c);
                    b === $.length - 1 && c + d - p[e - 1] > h && p.push(c);
                    c !== n && (n = c)
                });
                ...
                m.hide(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0;
            return a
        }, scroll: function (a, b) {
            ...
            e > d && (e = d);
            if (e > 0)b !== r && Xa(b, this.chart), this.nav.attr({translateX: j, translateY: f + this.padding + 7 + this.titleHeight, visibility: "visible"}), this.up.attr({fill: e === 1 ? g : h}).css({cursor: e === 1 ? "default" : "pointer"}), i.attr({text: e + "/" + d}), this.down.attr({x: 18 +
                this.pager.getBBox().width, fill: e === d ? g : h}).css({cursor: e === d ? "default" : "pointer"}), c = -c[e - 1] + this.initialItemY, this.scrollGroup.animate({translateY: c}), this.currentPage = e, this.positionCheckboxes(c)
        }};
    K = Highcharts.LegendSymbolMixin = {drawRectangle: function (a, b) {
    ...
    ya.prototype = {init: function (a, b) {
        ...
        (b = D[a.type || b.type || b.defaultSeriesType]) || pa(17, !0);
        b = new b;
        b.init(this, a);
        return b
        ...
        var b =
            this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, g, h, i = this.isDirtyBox, j = c.length, k = j, l = this.renderer, m = l.isHidden(), p = [];
        Xa(a, this);
        ...
        if (this.hasCartesianSeries) {
            ...
            q(b, function (a) {
                if (a.isDirtyExtremes)a.isDirtyExtremes = !1, p.push(function () {
                    N(a, "afterSetExtremes", u(a.eventArgs, a.getExtremes()));
                    delete a.eventArgs
                });
                (i || g) && a.redraw()
            })
        ...
        q(b === "xy" ? [1, 0] : [1], function (b) {
            ...
            h.series.length && l > y(k.dataMin, k.min) && i < s(k.dataMax, k.max) && (h.setExtremes(l, i, !1, !1, {trigger: "pan"}), e = !0);
            c[b ? "mouseDownX" : "mouseDownY"] = d
        });
        e && c.redraw(!1);
        z(c.container, {cursor: "move"})
        ...
        if (b && (b.css({width: (e.width || f) + "px"}).align(u({y: 15}, e), !1, "spacingBox"), !e.floating && !e.verticalAlign))a = b.getBBox().height, a >= 18 && a <= 25 && (a = 15);
        c && (c.css({width: (d.width || f) + "px"}).align(u({y: a + e.margin}, d), !1, "spacingBox"), !d.floating && !d.verticalAlign && (a = Va(a + c.getBBox().height)));
        this.titleOffset = a
    }, getChartSize: function () {
        var a = this.options.chart, b = this.renderToClone || this.renderTo;
        this.containerWidth = nb(b, "width");
        this.containerHeight = nb(b, "height");
        ...
        a ? b && (this.renderTo.appendChild(c), Sa(b), delete this.renderToClone) : (c &&
        ...
        e = "highcharts-" + Db++;
        if (ma(a))this.renderTo = a = F.getElementById(a);
        a || pa(13, !0);
        c = E(H(a, "data-highcharts-chart"));
        ...
        c = this.chartWidth;
        d = this.chartHeight;
        this.container = a = Z(Ta, {className: "highcharts-container" + (b.className ? " " + b.className : ""), id: e}, u({position: "relative", overflow: "hidden", width: c + "px", height: d + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)"}, b.style), this.renderToClone || a);
        this._cursor = a.style.cursor;
        this.renderer = b.forExport ? new sa(a, c, d, !0) : new Za(a, c, d);
        ...
        var b = this, c = b.options.chart,
            d = b.renderTo, e = c.width || nb(d, "width"), f = c.height || nb(d, "height"), c = a ? a.target : V, d = function () {
        ...
        if (t(a))d.chartWidth = e = s(0, v(a)), d.hasUserSize = !!e;
        if (t(b))d.chartHeight = f = s(0, v(b));
        (wa ? ob : z)(d.container, {width: e + "px", height: f + "px"}, wa);
        d.setChartSize(!0);
        ...
        N(d, "resize");
        wa === !1 ? g() : setTimeout(g, wa && wa.duration || 500)
        ...
        this.plotWidth = k = s(0, v(d - i - this.marginRight));
        this.plotHeight = l = s(0, v(e - j - this.marginBottom));
        ...
        d = 2 * Q(this.plotBorderWidth / 2);
        b = Va(s(d, h[3]) / 2);
        c = Va(s(d, h[0]) / 2);
        this.clipBox = {x: b, y: c, width: Q(this.plotSizeX - s(d, h[1]) / 2 - b), height: Q(this.plotSizeY - s(d, h[2]) / 2 - c)};
        ...
        if (k)f ? f.animate(s) : this.plotBackground = b.rect(n, o, q, x, 0).attr({fill: k}).add().shadow(a.plotShadow);
        if (l)h ? h.animate(s) : this.plotBGImage = b.image(l, n, o, q, x).add();
        r ? r.animate({width: v.width, height: v.height}) : this.clipRect = b.clipRect(v);
        if (m)g ? g.animate(g.crisp(null, n, o, q, x)) : this.plotBorder = b.rect(n, o, q, x, 0, -m).attr({stroke: a.plotBorderColor,
        ...
        q(["inverted", "angular", "polar"], function (g) {
            ...
            for (e = d && d.length; !f && e--;)(c = D[d[e].type]) && c.prototype[g] && (f = !0);
            a[g] = f
        })
    }, linkSeries: function () {
        ...
        q(b, function (b) {
            ...
            if (ma(d) && (d = d === ":previous" ? a.series[b.index - 1] : a.get(d)))d.linkedSeries.push(b),
                b.linkedParent = d
        })
    }, render: function () {
        var a = this, b = a.axes, c = a.renderer, d = a.options, e = d.labels, f = d.credits, g;
        a.setTitle();
        a.legend = new Jb(a, d.legend);
        a.getStacks();
        q(b, function (a) {
            a.setScale()
        });
        ...
        e.items && q(e.items, function (b) {
            var d = u(e.style, b.style), f = E(d.left) + a.plotLeft, g = E(d.top) + a.plotTop + 12;
            delete d.left;
            delete d.top;
        ...
        var a = this;
        return!da && V == V.top && F.readyState !==
            "complete" || ka && !V.canvg ? (ka ? Vb.push(function () {
            a.firstRender()
        ...
        if (a.isReadyToRender())a.getContainer(), N(a, "init"), a.resetMargins(), a.setChartSize(), a.propFromSeries(), a.getAxes(), q(b.series || [], function (b) {
            a.initSeries(b)
        }), a.linkSeries(), N(a, "beforeRender"),
            a.pointer = new $a(a, b), a.render(), a.renderer.draw(), c && c.apply(a, [a]), q(a.callbacks, function (b) {
            b.apply(a, [a])
        }), a.cloneRenderTo(!0), N(a, "load")
    }, splashArray: function (a, b) {
        var c = b[a], c = aa(c) ? c : [c, c, c, c];
        return[o(b[a + "Top"], c[0]), o(b[a + "Right"], c[1]), o(b[a + "Bottom"], c[2]), o(b[a + "Left"], c[3])]
    }};
    ya.prototype.callbacks = [];
    qa = Highcharts.CenteredSeriesMixin = {getCenter: function () {
        var a = this.options, b = this.chart, c = 2 * (a.slicedOffset || 0), d, e = b.plotWidth - 2 * c, f = b.plotHeight - 2 * c, b = a.center, a = [o(b[0], "50%"), o(b[1],
            "50%"), a.size || "100%", a.innerSize || 0], g = y(e, f), h;
        return Na(a, function (a, b) {
            h = /%$/.test(a);
            d = b < 2 || b === 2 && h;
            return(h ? [e, f, g, g][b] * E(a) / 100 : a) + (d ? c : 0)
        })
    }};
    var Da = function () {
    };
    Da.prototype = {init: function (a, b, c) {
        this.series = a;
        ...
        var c = this.series, d =
            c.pointValKey, a = Da.prototype.optionsToObject.call(this, a);
        u(this, a);
        ...
        c.firePointEvent(a ? "select" : "unselect", {accumulate: b}, function () {
            ...
            d.options.data[Aa(c, d.data)] = c.options;
            c.setState(a && "select");
        ...
        if (!b || Aa(this, b) === -1)this.firePointEvent("mouseOut"), this.setState(), a.hoverPoint =
            null
        ...
        var c = this.plotX, d = this.plotY, e = this.series, f = e.options.states, g = S[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], j = i && i.enabled === !1, k = e.stateMarkerGraphic, l = this.marker || {}, m = e.chart, p = this.pointAttr, a = a || "", b = b && k;
    ...
    M.prototype = {isCartesian: !0, type: "line", pointClass: Da, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, axisTypes: ["xAxis", "yAxis"], colorCounter: 0, parallelArrays: ["x", "y"], init: function (a, b) {
        ...
        c._i = f.length - 1;
        vb(f, g);
        this.yAxis && vb(this.yAxis.series, g);
        q(f, function (a, b) {
            a.index = b;
            a.name =
                a.name || "Series " + (b + 1)
        ...
        if (!e && !a.colorByPoint)t(b._colorIndex) ?
    ...
    }, drawLegendSymbol: K.drawLineMarker, setData: function (a, b) {
        ...
        if (j && k > j) {
            ...
            if (ua(g)) {
                ...
                c.xIncrement = i
            } else if (Pa(g))if (p)for (j = 0; j < k; j++)e = a[j], l[j] = e[0], m[j] = e.slice(1, p + 1); else for (j = 0; j < k; j++)e =
                a[j], l[j] = e[0], m[j] = e[1]; else pa(12)
        } else for (j = 0; j < k; j++)if (a[j] !== r && (e = {series: c}, c.pointClass.prototype.applyOptions.apply(e, [a[j]]), c.updateParallelArrays(e, j), i && e.name))h.names[e.x] = e.name;
        ma(m[0]) && pa(14, !0);
        c.data = [];
        c.options.data = a;
        ...
        for (h = b.length - 1; h >= 0; h--)d = b[h] - b[h - 1], d > 0 && (g === r || d < g) ? g = d : d < 0 && this.requireSorting && pa(15);
        this.cropped = f;
        this.cropStart = e;
        ...
        for (m = 0; m < g; m++)i =
            h + m, j ? l[m] = (new f).init(this, [d[m]].concat(ja(e[m]))) : (b[i] ? k = b[i] : a[i] !== r && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k);
        ...
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options, f = e.threshold, g = e.stack, e = e.stacking, h = this.stackKey,
                i = "-" + h, j = this.negStacks, k = this.yAxis, l = k.stacks, m = k.oldStacks, p, n, o, q, x;
            for (o = 0; o < d; o++) {
                q = a[o];
                x = b[o];
                n = (p = j && x < f) ? i : h;
                l[n] || (l[n] = {});
                if (!l[n][q])m[n] && m[n][q] ? (l[n][q] = m[n][q], l[n][q].total = null) : l[n][q] = new Qb(k, k.options.stackLabels, p, q, g, e);
                n = l[n][q];
                n.points[this.index] = [n.cum || 0];
                e === "percent" ? (p = p ? h : i, j && l[p] && l[p][q] ? (p = l[p][q], n.total = p.total = s(p.total, n.total) + O(x) || 0) : n.total = ga(n.total + (O(x) || 0))) : n.total = ga(n.total + (x || 0));
                n.cum = (n.cum || 0) + (x || 0);
        ...
        q([b, "-" + b], function (b) {
            var d;
            for (var e = a.xData.length, f, g; e--;)if (f = a.xData[e], d = (g = c[b] && c[b][f]) && g.points[a.index], f = d)g = g.total ? 100 / g.total : 0, f[0] = ga(f[0] * g), f[1] = ga(f[1] * g), a.stackedYData[e] = f[1]
        })
    }, getExtremes: function (a) {
        var b = this.yAxis, c = this.processedXData, d, e = [], f = 0;
        d = this.xAxis.getExtremes();
        var g = d.min, h = d.max, i, j, k, l, a = a || this.stackedYData ||
            this.processedYData;
        d = a.length;
        ...
        for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue,
            ...
            var l = f[a], m = l.x, p = l.y, n = l.low, q = b && e.stacks[(this.negStacks && p < k ? "-" : "") + this.stackKey];
            if (e.isLog && p <= 0)l.y = p = null;
            l.plotX = c.translate(m, 0, 0, 0, 1, i, this.type === "flags");
            if (b && this.visible && q && q[m])q = q[m], p = q.points[this.index], n = p[0], p = p[1], n === 0 && (n = o(k, e.min)), e.isLog && n <= 0 && (n = null), l.total = l.stackTotal = q.total, l.percentage = b === "percent" && l.y / q.total * 100, l.stackY = p, q.setOffset(this.pointXOffset || 0, this.barW || 0);
            l.yBottom = t(n) ?
                e.translate(n, 0, 1, 0, 1) : null;
            h && (p = this.modifyValue(p, l));
            l.plotY = typeof p === "number" && p !== Infinity ? e.translate(p, 0, 1, 0, 1) : r;
        ...
        if (this.options.enableMouseTracking !== !1) {
            ...
            for (i = 0; i < a; i++)if (e = b[i], c = e.x, c >= f.min && c <= f.max) {
                h = b[i + 1];
                c = d === r ? 0 : d + 1;
                for (d = b[i + 1] ? y(s(0, Q((e.clientX + (h ? h.wrappedClientX || h.clientX : g)) / 2)), g) : g; c >= 0 && c <= d;)j[c++] = e
            }
        ...
        f && d && ua(a.key) && (b = b.replace("{point.key}", "{point.key:" + d + "}"));
        return Ha(b, {point: a, series: this})
        ...
        c && !a.stickyTracking && (!c.shared ||
            this.noSharedTooltip) && c.hide();
        this.setState();
        b.hoverSeries = null
    }, animate: function (a) {
        ...
        if (e && !aa(e))e = S[b.type].animation;
        ...
        if (a)a = c[h], e = c[h + "m"], a || (c[h] = a = d.clipRect(u(f, {width: 0})), c[h + "m"] = e = d.clipRect(-99, g ? -c.plotLeft : -c.plotTop, 99, g ? c.chartWidth : c.chartHeight)), b.group.clip(a), b.markerGroup.clip(e), b.sharedClipKey = h; else {
            if (a = c[h])a.animate({width: c.plotSizeX}, e), c[h +
                "m"].animate({width: c.plotSizeX + 99}, e);
            b.animate = null;
        ...
        convertAttribs: function (a, b, c, d) {
            ...
            var a = this, b = a.options, c = S[a.type].marker ? b.marker : b, d = c.states, e = d.hover, f, g = a.color, h = {stroke: g, fill: g}, i = a.points || [], j = [], k, l = a.pointAttrToOptions, m = b.negativeColor, p = c.lineColor, n = c.fillColor, o;
            b.marker ? (e.radius = e.radius || c.radius + 2, e.lineWidth = e.lineWidth || c.lineWidth + 1) : e.color = e.color || Ba(e.color || g).brighten(e.brightness).get();
            ...
            for (g = i.length; g--;) {
                ...
                if (h.options)for (o in l)t(c[l[o]]) && (k = !0);
                if (k) {
                    c = c || {};
                    k = [];
                    d = c.states || {};
                    f = d.hover = d.hover || {};
                    if (!b.marker)f.color = Ba(f.color || h.color).brighten(f.brightness || e.brightness).get();
                    f = {color: h.color};
                    if (!n)f.fillColor = h.color;
                    if (!p)f.lineColor = h.color;
                    k[""] = a.convertAttribs(u(f, c), j[""]);
            ...
            q(a, function (e, f) {
                ...
                b.getPointSpline ? c.push.apply(c, b.getPointSpline(a, e, f)) : (c.push(f ? "L" : "M"), d && f && (i = a[f - 1], d === "right" ? c.push(i.plotX, h) : d === "center" ? c.push((i.plotX +
            ...
            q(["group", "dataLabelsGroup", "markerGroup",
                "tracker"], function (a) {
                if (c[a])c[a][f]()
            });
    ...
    u(ya.prototype, {addSeries: function (a, b, c) {
        var d, e = this;
        a && (b = o(b, !0), N(e, "addSeries", {options: a}, function () {
            d = e.initSeries(a);
            e.isDirtyLegend = !0;
            e.linkSeries();
            b && e.redraw(c)
        ...
        new W(this, w(a, {index: this[e].length, isX: b}));
        f[e] = ja(f[e] || {});
        f[e].push(a);
        o(c, !0) && this.redraw(d)
        ...
        if (!c)this.loadingDiv = c = Z(Ta,
            {className: "highcharts-loading"}, u(d.style, {zIndex: 10, display: ba}), this.container), this.loadingSpan = Z("span", null, d.labelStyle, c);
        this.loadingSpan.innerHTML = a || b.lang.loading;
        if (!this.loadingShown)z(c, {opacity: 0, display: "", left: this.plotLeft + "px", top: this.plotTop + "px", width: this.plotWidth + "px", height: this.plotHeight + "px"}), ob(c, {opacity: d.style.opacity}, {duration: d.showDuration || 0}), this.loadingShown = !0
    }, hideLoading: function () {
        var a = this.options, b = this.loadingDiv;
        b && ob(b, {opacity: 0}, {duration: a.loading.hideDuration ||
            100, complete: function () {
            z(b, {display: ba})
        }});
        this.loadingShown = !1
    }});
    u(Da.prototype, {update: function (a, b, c) {
    ...
    u(M.prototype, {addPoint: function (a, b, c, d) {
        ...
        var c = this.chart, d = this.type, e = D[d].prototype,
            f, a = w(this.userOptions, {animation: !1, index: this.index, pointStart: this.xData[0]}, {data: this.options.data}, a);
        this.remove(!1);
        for (f in e)e.hasOwnProperty(f) && (this[f] = r);
        u(this, D[a.type || d].prototype);
        this.init(c, a);
        o(b, !0) && c.redraw(!1)
    }});
    u(W.prototype, {update: function (a, b) {
        var c = this.chart, a = c.options[this.coll][this.options.index] = w(this.userOptions, a);
        this.destroy(!0);
        this._addedPlotLB = this.userMin = this.userMax = r;
        this.init(c, u(a, {events: r}));
        c.isDirtyBox = !0;
        o(b, !0) && c.redraw()
    }, remove: function (a) {
        var b =
    ...
    var ia = ea(M);
    D.line = ia;
    S.area = w(R, {threshold: 0});
    var ab = ea(M, {type: "area", getSegments: function () {
        ...
        q(f, function (d) {
            var e = d[0], f = a[e];
            f ? f.animate({d: b}) : a[e] = a.chart.renderer.path(b).attr({fill: o(d[2], Ba(d[1]).setOpacity(o(c.fillOpacity, 0.75)).get()), zIndex: 0}).add(a.group)
        })
    ...
    ia = ea(M, {type: "spline",
        getPointSpline: function (a, b, c) {
            ...
            if (f && g) {
                ...
                i += l;
                k += l;
                i > a && i > e ? (i = s(a, e), k = 2 * e - i) : i < a && i < e && (i = y(a, e), k = 2 * e - i);
                k > g && k > e ? (k = s(g, e), i = 2 * e - k) : k < g && k < e && (k = y(g, e), i = 2 * e - k);
                b.rightContX = j;
                b.rightContY = k
            }
    ...
    D.spline =
        ia;
    S.areaspline = w(S.area);
    ab = ab.prototype;
    ia = ea(ia, {type: "areaspline", closedStacks: !0, getSegmentPath: ab.getSegmentPath, closeSegment: ab.closeSegment, drawGraph: ab.drawGraph, drawLegendSymbol: K.drawRectangle});
    D.areaspline = ia;
    S.column = w(R, {borderColor: "#FFFFFF", borderWidth: 1, borderRadius: 0, groupPadding: 0.2, marker: null, pointPadding: 0.1, minPointLength: 0, cropThreshold: 50, pointRange: null, states: {hover: {brightness: 0.1, shadow: !1}, select: {color: "#C0C0C0", borderColor: "#000000", shadow: !1}}, dataLabels: {align: null,
        verticalAlign: null, y: null}, stickyTracking: !1, threshold: 0});
    ia = ea(M, {type: "column", pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color", r: "borderRadius"}, cropShoulder: 0, trackerGroups: ["group", "dataLabelsGroup"], negStacks: !0, init: function () {
        ...
        var c = y(O(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || 1), c.len), j = c * b.groupPadding, k = (c - 2 * j) / i, l = b.pointWidth, b = t(l) ? (k - l) / 2 : k * b.pointPadding, l = o(l, k - 2 * b);
        return a.columnMetrics = {width: l, offset: b + (j + ((e ? i - (a.columnIndex || 0) : a.columnIndex) || 0) * k - c / 2) * (e ? -1 : 1)}
    }, translate: function () {
        var a =
            this.chart, b = this.options, c = b.borderWidth, d = this.yAxis, e = this.translatedThreshold = d.getThreshold(b.threshold), f = o(b.minPointLength, 5), b = this.getColumnMetrics(), g = b.width, h = this.barW = Va(s(g, 1 + 2 * c)), i = this.pointXOffset = b.offset, j = -(c % 2 ? 0.5 : 0), k = c % 2 ? 0.5 : 1;
        a.renderer.isVML && a.inverted && (k += 1);
        M.prototype.translate.apply(this);
        q(this.points, function (a) {
            var b = o(a.yBottom, e), c = y(s(-999 - b, a.plotY), d.len + 999 + b), n = a.plotX + i, q = h, r = y(c, b), x, c = s(c, b) - r;
            O(c) < f && f && (c = f, r = v(O(r - e) > f ? b - f : e - (d.translate(a.y, 0, 1, 0,
                1) <= e ? f : 0)));
            a.barX = n;
            a.pointWidth = g;
            b = O(n) < 0.5;
            ...
            x && (r -= 1, c += 1);
            a.shapeType = "rect";
            a.shapeArgs = {x: n, y: r, width: q, height: c}
        })
        ...
        q(a.points, function (g) {
            ...
            if (h !== r && !isNaN(h) && g.y !== null)f = g.shapeArgs, i ? (eb(i), i[b.pointCount < e ? "animate" : "attr"](w(f))) :
        ...
        if (da)a ? (e.scaleY = 0.001, a = y(b.pos + b.len, s(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation),
            this.animate = null)
    }, remove: function () {
        var a = this, b = a.chart;
        b.hasRendered && q(b.series, function (b) {
    ...
    D.column = ia;
    S.bar = w(S.column);
    ia = ea(ia, {type: "bar", inverted: !0});
    D.bar = ia;
    S.scatter = w(R, {lineWidth: 0, tooltip: {headerFormat: '<span style="font-size: 10px; color:{series.color}">{series.name}</span><br/>', pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>", followPointer: !0}, stickyTracking: !1});
    ia = ea(M, {type: "scatter", sorted: !1,
        requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["markerGroup"], takeOrdinalPosition: !1, drawTracker: fb.drawTrackerPoint, drawGraph: function () {
            this.options.lineWidth && M.prototype.drawGraph.call(this)
        }, setTooltipPoints: la});
    D.scatter = ia;
    S.pie = w(R, {borderColor: "#FFFFFF", borderWidth: 1, center: [null, null], clip: !1, colorByPoint: !0, dataLabels: {distance: 30, enabled: !0, formatter: function () {
    ...
    R = {type: "pie", isCartesian: !1, pointClass: ea(Da, {init: function () {
        ...
        e = a ? "show" : "hide";
        q(["graphic", "dataLabel", "connector", "shadowGroup"], function (a) {
            if (b[a])b[a][e]()
        });
        ...
        d.options.data[Aa(this, d.data)] = this.options;
        a = a ? this.slicedTranslation : {translateX: 0, translateY: 0};
        this.graphic.animate(a);
        this.shadowGroup && this.shadowGroup.animate(a)
    }}), requireSorting: !1,
        noSharedTooltip: !0, trackerGroups: ["group", "dataLabelsGroup"], axisTypes: [], pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color"}, getColor: la, animate: function (a) {
            ...
            this.generatePoints();
            var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0, j = this.startAngleRad = Ka / 180 * (i - 90), i = (this.endAngleRad = Ka / 180 * ((c.endAngle || i + 360) - 90)) -
                j, k = this.points, l = c.dataLabels.distance, c = c.ignoreHiddenPoint, m, p = k.length, n;
            ...
            for (m = 0; m < p; m++) {
                ...
                g = j + b * i;
                n.shapeType = "arc";
                n.shapeArgs = {x: a[0], y: a[1], r: a[2] / 2, innerR: a[3] / 2, start: v(f * 1E3) / 1E3, end: v(g * 1E3) / 1E3};
                h = (g + f) / 2;
                h > 0.75 * i && (h -= 2 * Ka);
                n.slicedTranslation = {translateX: v(ca(h) * d), translateY: v(ha(h) * d)};
                f = ca(h) * a[2] / 2;
                g =
                    ha(h) * a[2] / 2;
                n.tooltipPos = [a[0] + f * 0.7, a[1] + g * 0.7];
                n.half = h < -Ka / 2 || h > Ka / 2 ? 1 : 0;
                n.angle = h;
                e = y(e, l / 2);
        ...
        }, drawTracker: fb.drawTrackerPoint, drawLegendSymbol: K.drawRectangle, getCenter: qa.getCenter, getSymbol: la};
    R = ea(M,
        R);
    D.pie = R;
    M.prototype.drawDataLabels = function () {
        var a = this, b = a.options, c = b.cursor, d = b.dataLabels, b = a.points, e, f, g, h;
        if (d.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(d), h = a.plotGroup("dataLabelsGroup", "data-labels", a.visible ? "visible" : "hidden", d.zIndex || 6), f = d, q(b, function (b) {
            var j, k = b.dataLabel, l, m, p = b.connector, n = !0;
            ...
            if (k && !j)b.dataLabel = k.destroy(); else if (j) {
                ...
                l = b.getLabelConfig();
                g = d.format ?
                    Ha(d.format, l) : d.formatter.call(l, d);
                d.style.color = o(d.color, d.style.color, a.color, "black");
                if (k)if (t(g))k.attr({text: g}), n = !1; else {
    ...
    M.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        if (a = this.visible && (a.series.forceDL || f.isInsidePlot(a.plotX, a.plotY, g)))d = u({x: g ? f.plotWidth - i : h, y: v(g ? f.plotHeight - h : i), width: 0, height: 0}, d), u(c, {width: j.width, height: j.height}), c.rotation ? (g = {align: c.align, x: d.x + c.x + d.width / 2, y: d.y + c.y + d.height / 2}, b[e ? "attr" : "animate"](g)) : (b.align(c, null, d), g = b.alignAttr, o(c.overflow, "justify") === "justify" ?
            this.justifyDataLabel(b, c, g, j, d, e) : o(c.crop, !0) && (a = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)));
    ...
    M.prototype.justifyDataLabel = function (a, b, c, d, e, f) {
        ...
        j = c.y + d.height;
        if (j > g.plotHeight)i === "top" ? b.verticalAlign =
            "bottom" : b.y = g.plotHeight - j, k = !0;
        if (k)a.placed = !f, a.align(b, null, e)
    };
    if (D.pie)D.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = o(e.connectorPadding, 10), g = o(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, i, j, k = o(e.softConnector, !0), l = e.distance, m = a.center, p = m[2] / 2, n = m[1], r = l > 0, t, x, u, w, y = [
            [],
            []
        ], A, I, E, G, C, P = [0, 0, 0, 0], H = function (a, b) {
            return b.y - a.y
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (G = 0; !w && b[G];)w = b[G] && b[G].dataLabel && (b[G].dataLabel.getBBox().height || 21), G++;
            for (G = 2; G--;) {
                var b = [], F = [], D = y[G], B = D.length, z;
                a.sortByAngle(D, G - 0.5);
                if (l > 0) {
                    for (C = n - p - l; C <= n + p + l; C += w)b.push(C);
                    x = b.length;
                    if (B > x) {
                        c = [].concat(D);
                        c.sort(H);
                        for (C = B; C--;)c[C].rank = C;
                        for (C = B; C--;)D[C].rank >= x && D.splice(C, 1);
                        B = D.length
                    }
                    for (C = 0; C < B; C++) {
                        c = D[C];
                        ...
                        c = 9999;
                        var L, K;
                        for (K = 0; K < x; K++)L = O(b[K] - u[1]), L < c && (c = L, z = K);
                        if (z < C && b[C] !== null)z = C; else for (x < B - C + z && b[C] !== null &&
                                                                        (z = x - B + C); b[z] === null;)z++;
                        F.push({i: z, y: b[z]});
                        b[z] = null
                    }
                ...
                for (C = 0; C < B; C++) {
                    ...
                    A = e.justify ? m[0] + (G ? -1 : 1) * (p + l) : a.getX(z === 0 || z === b.length - 1 ? c : I, G);
                    t._attr = {visibility: E, align: u[6]};
                    t._pos = {x: A + e.x + ({left: f, right: -f}[u[6]] || 0), y: I + e.y - 10};
                    t.connX = A;
                    t.connY = I;
                    if (this.options.size === null)x = t.width, A - x < f ? P[3] = s(v(x - A + f), P[3]) : A + x > h - f &&
            ...
            if (va(P) === 0 || this.verifyDataLabelOverflow(P))this.placeDataLabels(), r && g && q(this.points, function (b) {
                i = b.connector;
                u = b.labelPos;
                if ((t = b.dataLabel) && t._pos)E = t._attr.visibility, A = t.connX, I = t.connY, j = k ? ["M", A + (u[6] === "left" ? 5 : -5), I, "C", A, I, 2 * u[2] - u[4], 2 * u[3] - u[5], u[2], u[3], "L", u[4], u[5]] : ["M", A + (u[6] === "left" ? 5 : -5), I, "L", u[2], u[3], "L", u[4], u[5]], i ? (i.animate({d: j}), i.attr("visibility", E)) : b.connector = i = a.chart.renderer.path(j).attr({"stroke-width": g,
        ...
        d[0] !== null ? e = s(b[2] - s(a[1], a[3]), c) : (e = s(b[2] - a[1] - a[3],
            c), b[0] += (a[3] - a[1]) / 2);
        d[1] !== null ? e = s(y(e, b[2] - s(a[0], a[2])), c) : (e = s(y(e, b[2] - a[0] - a[2]), c), b[1] += (a[0] - a[2]) / 2);
    ...
    U(W.prototype, "getTimeTicks", function (a, b, c, d, e, f, g, h) {
        var i = 0, j = 0, k, l = {}, m, p, n, o = [], q = -Number.MAX_VALUE, x = this.options.tickPixelInterval;
        if (!this.options.ordinal || !f || f.length < 3 || c === r)return a.call(this, b, c, d, e);
        for (p = f.length; j < p; j++) {
            n = j && f[j - 1] > d;
            f[j] < c && (i = j);
            if (j === p - 1 || f[j + 1] - f[j] > g * 5 || n) {
                if (f[j] > q) {
        ...
        a = k.info;
        if (h && a.unitRange <= B.hour) {
            j = o.length - 1;
            for (i = 1; i < j; i++)(new Date(o[i] -
                Ja))[Ua]() !== (new Date(o[i - 1] - Ja))[Ua]() && (l[o[i]] = "day", m = !0);
            m && (l[o[0]] = "day");
            a.higherRanks = l
        }
        o.info = a;
        if (h && t(x)) {
            var h = a = o.length, j = [], s;
            for (m = []; h--;)i = this.translate(o[h]), s && (m[h] = s - i), j[h] = s = i;
            m.sort();
            m = m[Q(m.length / 2)];
            m < x * 0.6 && (m = null);
            h = o[a - 1] > d ? a - 1 : a;
            for (s = void 0; h--;)i = j[h], d = s - i, s && d < x * 0.8 && (m === null || d < m * 0.8) ? (l[o[h]] && !l[o[h + 1]] ? (d = h + 1, s = i) : d = h, o.splice(d, 1)) : s = i
        }
        return o
    });
    u(W.prototype, {beforeSetTickPositions: function () {
        ...
        if (this.options.ordinal) {
            ...
            c ? (this.ordinalPositions = b, c = this.val2lin(s(f, b[0]), !0), d = this.val2lin(y(e, b[b.length - 1]), !0), this.ordinalSlope = e = (e - f) / (d - c), this.ordinalOffset =
        ...
        if (c) {
            ...
            if (b)a < 0 ? a = c[0] : a > f ? a = c[f] : (f = Q(a),
    ...
    U(ya.prototype, "pan", function (a, b) {
        ...
        if (c.options.ordinal && c.series.length) {
            var f = this.mouseDownX, g = c.getExtremes(), h = g.dataMax, i = g.min, j = g.max, k = this.hoverPoints, l = c.closestPointRange, f = (f - d) / (c.translationSlope * (c.ordinalSlope || l)), m = {ordinalPositions: c.getExtendedPositions()}, l = c.lin2val, p = c.val2lin, n;
    ...
    U(M.prototype, "getSegments", function (a) {
        var b,
            c = this.options.gapSize, d = this.xAxis;
        a.apply(this, Array.prototype.slice.call(arguments, 1));
        if (c)b = this.segments, q(b, function (a, f) {
            for (var g = a.length - 1; g--;)a[g + 1].x - a[g].x > d.closestPointRange * c && b.splice(f + 1, 0, a.splice(g + 1, a.length - g))
        })
    });
    var Y = M.prototype, fc = Y.processData, gc = Y.generatePoints, hc = Y.destroy, ic = Y.tooltipHeaderFormatter, jc = {approximation: "average", groupPixelWidth: 2, dateTimeLabelFormats: gb("millisecond", ["%A, %b %e, %H:%M:%S.%L", "%A, %b %e, %H:%M:%S.%L", "-%H:%M:%S.%L"], "second", ["%A, %b %e, %H:%M:%S",
        ...
        groupPixelWidth: 10}, candlestick: {approximation: "ohlc", groupPixelWidth: 10}, ohlc: {approximation: "ohlc", groupPixelWidth: 5}}, Xb = [
        ["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]],
        ["second", [1, 2, 5, 10, 15, 30]],
        ["minute", [1, 2, 5, 10, 15, 30]],
        ["hour", [1, 2, 3, 4, 6, 8, 12]],
    ...
    Y.groupData = function (a, b, c, d) {
        var e = this.data, f = this.options.data, g = [], h = [], i = a.length, j, k, l = !!b, m = [
            ...
            [],
            []
        ], d = typeof d === "function" ? d : Oa[d], p = this.pointArrayMap, n = p && p.length, o;
        for (o = 0; o <= i; o++) {
            for (; c[1] !== r && a[o] >= c[1] || o === i;)if (j = c.shift(), k = d.apply(0, m), k !== r && (g.push(j), h.push(k)), m[0] = [], m[1] = [], m[2] = [], m[3] = [], o === i)break;
            if (o === i)break;
            if (p) {
                j = this.cropStart + o;
                j = e && e[j] || this.pointClass.prototype.applyOptions.apply({series: this}, [f[j]]);
                var q;
                for (k = 0; k < n; k++)if (q = j[p[k]], typeof q ===
    ...
    Y.processData = function () {
        ...
        if (fc.apply(this, arguments) !== !1 && d) {
            ...
            var f = this.processedXData, g = this.processedYData, h = a.plotSizeX, i = this.xAxis, j = i.options.ordinal, k = this.groupPixelWidth = i.getGroupPixelWidth &&
                i.getGroupPixelWidth(), a = this.pointRange;
            if (k) {
                e = !0;
                this.points = null;
                d = i.getExtremes();
                a = d.min;
                d = d.max;
                j = j && i.getGroupIntervalFactor(a, d, this) || 1;
                h = k * (d - a) / h * j;
                i = i.getTimeTicks(i.normalizeTimeTickInterval(h, c.units || Xb), a, d, null, f, this.closestPointRange);
                g = Y.groupData.apply(this, [f, g, i, c.approximation]);
                f = g[0];
                g = g[1];
                if (c.smoothed) {
                    c = f.length - 1;
    ...
    Y.tooltipHeaderFormatter = function (a) {
        var b = this.tooltipOptions, c = this.options.dataGrouping, d = b.xDateFormat, e, f = this.xAxis,
            g, h;
        if (f && f.options.type === "datetime" && c && ua(a.key)) {
            g = this.currentDataGrouping;
            c = c.dateTimeLabelFormats;
            if (g)f = c[g.unitName], g.count === 1 ? d = f[0] : (d = f[1], e = f[2]); else if (!d && c)for (h in B)if (B[h] >= f.closestPointRange) {
                d = c[h][0];
                break
            }
            d = ra(d, a.key);
            e && (d += ra(e, a.key + g.totalRange - 1));
    ...
    U(Y, "setOptions", function (a, b) {
        var c = a.call(this,
            b), d = this.type, e = this.chart.options.plotOptions, f = S[d].dataGrouping;
        if (Wb[d])f || (f = w(jc, Wb[d])), c.dataGrouping = w(f, e.series && e.series.dataGrouping, e[d].dataGrouping, b.dataGrouping);
    ...
    W.prototype.getGroupPixelWidth = function () {
        ...
        for (c = b; c--;)(f = a[c].options.dataGrouping) && (d = s(d, f.groupPixelWidth));
        for (c = b; c--;)if (f = a[c].options.dataGrouping)if (b = (a[c].processedXData || a[c].data).length, a[c].groupPixelWidth ||
            b > this.chart.plotSizeX / d || b && f.forced)e = !0;
        return e ? d : 0
    };
    S.ohlc = w(S.column, {lineWidth: 1, tooltip: {pointFormat: '<span style="color:{series.color};font-weight:bold">{series.name}</span><br/>Open: {point.open}<br/>High: {point.high}<br/>Low: {point.low}<br/>Close: {point.close}<br/>'}, states: {hover: {lineWidth: 3}}, threshold: null});
    R = ea(D.column, {type: "ohlc", pointArrayMap: ["open", "high", "low", "close"], toYData: function (a) {
        return[a.open, a.high, a.low, a.close]
    }, pointValKey: "high", pointAttrToOptions: {stroke: "color",
        "stroke-width": "lineWidth"}, upColorProp: "stroke", getAttribs: function () {
        ...
        animate: null});
    D.ohlc = R;
    S.candlestick = w(S.column, {lineColor: "black", lineWidth: 1, states: {hover: {lineWidth: 2}}, tooltip: S.ohlc.tooltip, threshold: null, upColor: "white"});
    R = ea(R, {type: "candlestick", pointAttrToOptions: {fill: "color", stroke: "lineColor", "stroke-width": "lineWidth"}, upColorProp: "fill", getAttribs: function () {
        D.ohlc.prototype.getAttribs.apply(this, arguments);
        ...
        var a = this, b = a.chart, c, d, e, f, g, h, i, j, k, l, m, p;
        q(a.points, function (n) {
            l = n.graphic;
            if (n.plotY !== r)c = n.pointAttr[n.selected ? "selected" : ""], j = c["stroke-width"] % 2 / 2, k = v(n.plotX) + j, d = n.plotOpen, e = n.plotClose, f = T.min(d, e), g = T.max(d, e), p = v(n.shapeArgs.width / 2), h = v(f) !== v(n.plotY), i = g !== n.yBottom, f = v(f) + j, g = v(g) + j, m = ["M", k - p, g, "L", k - p, f, "L", k + p, f, "L", k + p, g, "L", k - p, g, "M", k, f, "L", k, h ? v(n.plotY) : f,
                "M", k, g, "L", k, i ? v(n.yBottom) : g, "Z"], l ? l.animate({d: m}) : n.graphic = b.renderer.path(m).attr(c).add(a.group).shadow(a.options.shadow)
        })
    }});
    D.candlestick = R;
    var sb = sa.prototype.symbols;
    S.flags = w(S.column, {dataGrouping: null, fillColor: "white", lineWidth: 1, pointRange: 0, shape: "flag", stackDistance: 12, states: {hover: {lineColor: "black", fillColor: "#FCFFC5"}}, style: {fontSize: "11px", fontWeight: "bold", textAlign: "center"}, tooltip: {pointFormat: "{point.text}<br/>"}, threshold: null, y: -30});
    D.flags = ea(D.column, {type: "flags",
        sorted: !1, noSharedTooltip: !0, takeOrdinalPosition: !1, trackerGroups: ["markerGroup"], forceCrop: !0, init: M.prototype.init, pointAttrToOptions: {fill: "fillColor", stroke: "color", "stroke-width": "lineWidth", r: "radius"}, translate: function () {
            ...
            var a,
                b = this.points, c = this.chart.renderer, d, e, f = this.options, g = f.y, h, i, j, k, l = f.lineWidth % 2 / 2, m, p;
            for (i = b.length; i--;)if (j = b[i], a = j.plotX > this.xAxis.len, d = j.plotX + (a ? l : -l), k = j.stackIndex, h = j.options.shape || f.shape, e = j.plotY, e !== r && (e = j.plotY + g + l - (k !== r && k * f.stackDistance)), m = k ? r : j.plotX + l, p = k ? r : j.plotY, k = j.graphic, e !== r && d >= 0 && !a)a = j.pointAttr[j.selected ? "select" : ""], k ? k.attr({x: d, y: e, r: a.r, anchorX: m, anchorY: p}) : j.graphic = c.label(j.options.title || f.title || "A", d, e, h, m, p, f.useHTML).css(w(f.style, j.style)).attr(a).attr({align: h ===
                "flag" ? "left" : "center", width: f.width, height: f.height}).add(this.markerGroup).shadow(f.shadow), j.tooltipPos = [d, e]; else if (k)j.graphic = k.destroy()
        }, drawTracker: function () {
            var a = this.points;
            fb.drawTrackerPoint.apply(this);
            q(a, function (b) {
                var c = b.graphic;
    ...
    R = gb("linearGradient", {x1: 0, y1: 0, x2: 0, y2: 1}, "stops", [
        [0, "#FFF"],
        [1, "#CCC"]
    ]);
    K = [].concat(Xb);
    K[4] = ["day", [1, 2, 3, 4]];
    K[5] = ["week", [1, 2, 3]];
    u(L, {navigator: {handles: {backgroundColor: "#FFF",
        ...
        {x1: 0, y1: 0, x2: 0, y2: 1}, "stops", [
            [0, "#EEE"],
            [1, "#FFF"]
        ]), trackBorderColor: "#CCC", trackBorderWidth: 1, liveRedraw: da && !cb}});
    Bb.prototype = {drawHandle: function (a, b) {
        ...
        this.rendered || (f[b] = d.g().css({cursor: "e-resize"}).attr({zIndex: 4 - b}).add(), h = d.rect(-4.5, 0, 9, 16, 3, 1).attr(g).add(f[b]), e.push(h), h = d.path(["M", -1.5, 4, "L", -1.5, 12, "M", 0.5, 4,
            "L", 0.5, 12]).attr(g).add(f[b]), e.push(h));
        ...
        this.rendered || (d[a] = b.g().add(this.scrollbarGroup), g = b.rect(-0.5, -0.5, e + 1, e + 1, f.buttonBorderRadius, f.buttonBorderWidth).attr({stroke: f.buttonBorderColor, "stroke-width": f.buttonBorderWidth,
            fill: f.buttonBackgroundColor}).add(d[a]), c.push(g), g = b.path(["M", e / 2 + (a ? -1 : 1), e / 2 - 3, "L", e / 2 + (a ? -1 : 1), e / 2 + 3, e / 2 + (a ? 2 : -2), e / 2]).attr({fill: f.buttonArrowColor}).add(d[a]), c.push(g));
        ...
        var e = this.chart, f = e.renderer, g, h, i, j, k = this.scrollbarGroup, l = this.navigatorGroup, m = this.scrollbar, l = this.xAxis, p = this.scrollbarTrack, n = this.scrollbarHeight, q = this.scrollbarEnabled, r = this.navigatorOptions, x = this.scrollbarOptions, t = x.minWidth, u = this.height,
            w = this.top, A = this.navigatorEnabled, I = r.outlineWidth, z = I / 2, G = 0, C = this.outlineHeight, E = x.barBorderRadius, D = x.barBorderWidth, B = w + z, F;
        if (!isNaN(a)) {
            ...
            l.getExtremes && (F = this.getUnionExtremes(!0)) && (F.dataMin !== l.min || F.dataMax !== l.max) && l.setExtremes(F.dataMin, F.dataMax, !0, !1);
            c = o(c, l.translate(a));
            d = o(d, l.translate(b));
            if (isNaN(c) || O(c) === Infinity)c = 0, d = j;
            this.zoomedMax =
                y(s(c, d), h);
            this.zoomedMin = s(this.fixedWidth ? this.zoomedMax - this.fixedWidth : y(c, d), 0);
            this.range = this.zoomedMax - this.zoomedMin;
            c = v(this.zoomedMax);
            b = v(this.zoomedMin);
            a = c - b;
            if (!this.rendered) {
                if (A)this.navigatorGroup = l = f.g("navigator").attr({zIndex: 3}).add(), this.leftShade = f.rect().attr({fill: r.maskFill}).add(l), this.rightShade = f.rect().attr({fill: r.maskFill}).add(l), this.outline = f.path().attr({"stroke-width": I, stroke: r.outlineColor}).add(l);
                if (q)this.scrollbarGroup = k = f.g("scrollbar").add(), m = x.trackBorderWidth,
            ...
            A && (this.leftShade[e]({x: g, y: w, width: b, height: u}), this.rightShade[e]({x: g + c, y: w, width: h - c, height: u}),
                this.outline[e]({d: ["M", i, B, "L", g + b + z, B, g + b + z, B + C - n, "M", g + c - z, B + C - n, "L", g + c - z, B, i + j, B]}), this.drawHandle(b + z, 0), this.drawHandle(c + z, 1));
            if (q && k)this.drawScrollbarButton(0), this.drawScrollbarButton(1), k[e]({translateX: i, translateY: v(B + u)}), p[e]({width: j}), g = n + b, h = a - D, h < t && (G = (t - h) / 2, h = t, g -= G), this.scrollbarPad = G, m[e]({x: Q(g) + D % 2 / 2, width: h}), t = n + b + a / 2 - 0.5, this.scrollbarRifles.attr({visibility: a > 12 ? "visible" : "hidden"})[e]({d: ["M", t - 3, n / 4, "L", t - 3, 2 * n / 3, "M", t, n / 4, "L", t, 2 * n / 3, "M", t + 3, n / 4, "L", t + 3, 2 * n / 3]});
            this.scrollbarPad = G;
            this.rendered = !0
        }
    }, addEvents: function () {
        ...
        this._events = r;
        this.navigatorEnabled && this.baseSeries && X(this.baseSeries, "updatedData",
        ...
        a.mouseDownHandler = function (d) {
            var d = b.pointer.normalize(d), e = a.zoomedMin, f = a.zoomedMax, h = a.top, j = a.scrollbarHeight, m = a.scrollerLeft, n = a.scrollerWidth, p = a.navigatorLeft, o = a.navigatorWidth, q = a.scrollbarPad, r = a.range, s = d.chartX, t = d.chartY, d = b.xAxis[0], u, v = cb ? 10 : 7;
            if (t > h && t < h + g + j)if ((h = !a.scrollbarEnabled || t < h + g) && T.abs(s - e - p) < v)a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null; else if (h && T.abs(s - f - p) < v)a.grabbedRight = !0, a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null; else if (s > p + e - q && s < p + f + q) {
                a.grabbedCenter = s;
                a.fixedWidth = r;
                if (b.renderer.isSVG)l = k.cursor, k.cursor = "ew-resize";
                i = s - e
            } else if (s > m && s < m + n) {
                f = h ? s - p - r / 2 : s < p ? e - r * 0.2 : s > m + n - j ? e + r * 0.2 : s < p + e ? e - r : f;
                if (f < 0)f = 0; else if (f + r >= o)f = o - r, u = c.dataMax;
                if (f !== e)a.fixedWidth = r, e = c.toFixedRange(f, f + r, null, u), d.setExtremes(e.min, e.max, !0, !1, {trigger: "navigator"})
            }
        };
        ...
        }, toFixedRange: W.prototype.toFixedRange};
        U(b, "getMargins", function (b) {
            var e = this.legend, f = e.options;
            b.call(this);
            a.top = h = a.navigatorOptions.top || this.chartHeight - a.height - a.scrollbarHeight - this.spacing[2] - (f.verticalAlign === "bottom" && f.enabled && !f.floating ? e.legendHeight + o(f.margin,
                10) : 0);
        ...
        if (!a || b.dataMin !== null)return{dataMin: o(d && d.min, (t(b.dataMin) && t(c.dataMin) ? y : o)(b.dataMin, c.dataMin)), dataMax: o(d && d.max, (t(b.dataMax) && t(c.dataMax) ? s : o)(b.dataMax, c.dataMax))}
        ...
        var a = this.chart.scroller, b = a.baseSeries, c = b.xAxis, d = c.getExtremes(), e = d.min, f = d.max, g = d.dataMin, d = d.dataMax, h = f - e, i, j, k, l, m, p = a.series;
        i = p.xData;
        var n = !!c.setExtremes;
        ...
        i && (l = g, k = l + h);
        j && (k = d, i || (l = s(k - h, p.xData[0])));
        n && (i || j) ? isNaN(l) || c.setExtremes(l,
    ...
    Highcharts.Scroller = Bb;
    U(W.prototype, "zoom", function (a, b, c) {
    ...
    U(M.prototype, "addPoint", function (a, b, c, d, e) {
        ...
        f && this.xData.length > f && aa(b) && !Pa(b) && this.chart.scroller && pa(20, !0);
        a.call(this, b, c, d, e)
    });
    u(L, {rangeSelector: {buttonTheme: {width: 28, height: 16, padding: 1, r: 0, stroke: "#68A", zIndex: 7}, inputPosition: {align: "right"}, labelStyle: {color: "#666"}}});
    L.lang = w(L.lang, {rangeSelectorZoom: "Zoom", rangeSelectorFrom: "From", rangeSelectorTo: "To"});
    Cb.prototype = {clickButton: function (a, b) {
        var c = this, d = c.selected, e = c.chart, f = c.buttons, g = c.buttonOptions[a], h = e.xAxis[0], i = e.scroller && e.scroller.getUnionExtremes() || h || {}, j = i.dataMin, k = i.dataMax, l, m = h && v(y(h.max, o(k, h.max))), p = new Date(m), n = g.type, t = g.count, i = g._range, u;
        if (!(j === null || k === null || a === c.selected)) {
            ...
            f[a] && f[a].setState(2);
            e.fixedRange = i;
            h ? h.setExtremes(l, m, o(b, 1), 0, {trigger: "rangeSelectorButton", rangeSelectorButton: g}) : (d = e.options.xAxis, d[0] = w(d[0],
                {range: i, min: u}));
            c.setSelected(a)
        }
        ...
        a && c.fixedRange !== v(d.max - d.min) && (i[h] && i[h].setState(0), b.setSelected(null));
        q(b.buttonOptions,
            function (a, c) {
                var e = a._range, m = e > g - f, p = e < d.minRange, n = a.type === "all" && d.max - d.min >= g - f && i[c].state !== 2, o = a.type === "ytd" && ra("%Y", f) === ra("%Y", g);
                e === v(d.max - d.min) && c !== h ? (b.setSelected(c), i[c].setState(2)) : m || p || n || o ? i[c].setState(3) : i[c].state === 3 && i[c].setState(0)
            })
        ...
        var b = this, c = b.chart, d = c.options.chart.style, e = c.renderer, f = c.options.rangeSelector, g = b.div, h = a === "min", i, j, k, l = this.inputGroup;
        this[a + "Label"] = j = e.label(L.lang[h ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).attr({padding: 1}).css(w(d,
            f.labelStyle)).add(l);
        l.offset += j.width + 5;
        this[a + "DateBox"] = k = e.label("", l.offset).attr({padding: 1, width: f.inputBoxWidth || 90, height: f.inputBoxHeight || 16, stroke: f.inputBoxBorderColor || "silver", "stroke-width": 1}).css(w({textAlign: "center"}, d, f.inputStyle)).on("click",function () {
            b[a + "Input"].focus()
        }).add(l);
        l.offset += k.width + (h ? 10 : 0);
        this[a + "Input"] = i = Z("input", {name: a, className: "highcharts-range-selector", type: "text"}, u({position: "absolute", border: 0, width: "1px", height: "1px", padding: 0, textAlign: "center",
            fontSize: d.fontSize, fontFamily: d.fontFamily, top: c.plotTop + "px"}, f.inputStyle), g);
        i.onfocus = function () {
            z(this, {left: l.translateX + k.x + "px", top: l.translateY + "px", width: k.width - 2 + "px", height: k.height - 2 + "px", border: "2px solid silver"})
        };
        i.onblur = function () {
            z(this, {border: 0, width: "1px", height: "1px"});
            b.setInputValue(a)
        };
        i.onchange = function () {
            var a = i.value, d = (f.inputDateParser || Date.parse)(a), e = c.xAxis[0], g = e.dataMin, j = e.dataMax;
            isNaN(d) && (d = a.split("-"), d = Date.UTC(E(d[0]), E(d[1]) - 1, E(d[2])));
            isNaN(d) ||
        ...
        var c = this, d = c.chart, e = d.renderer, f = d.container, g = d.options, h = g.exporting && g.navigation && g.navigation.buttonOptions, i = g.rangeSelector, j = c.buttons, g = L.lang, k = c.div, k = c.inputGroup, l = i.buttonTheme, m = i.inputEnabled !== !1, o = l && l.states, n = d.plotLeft, r;
        if (!c.rendered &&
            (c.zoomText = e.text(g.rangeSelectorZoom, n, d.plotTop - 10).css(i.labelStyle).add(), r = n + c.zoomText.getBBox().width + 5, q(c.buttonOptions, function (a, b) {
                j[b] = e.button(a.text, r, d.plotTop - 25,function () {
                    c.clickButton(b);
                    c.isActive = !0
                }, l, o && o.hover, o && o.select).css({textAlign: "center"}).add();
                r += j[b].width + (i.buttonSpacing || 0);
                c.selected === b && j[b].setState(2)
            }), c.updateButtonStates(), m))c.div = k = Z("div", null, {position: "relative", height: 0, zIndex: 1}), f.parentNode.insertBefore(k, f), c.inputGroup = k = e.g("input-group").add(),
            k.offset = 0, c.drawInput("min"), c.drawInput("max");
        m && (f = d.plotTop - 35, k.align(u({y: f, width: k.offset, x: h && f < (h.y || 0) + h.height - d.spacing[0] ? -40 : 0}, i.inputPosition), !0, d.spacingBox), c.setInputValue("min", a), c.setInputValue("max", b));
        c.rendered = !0
    }, destroy: function () {
    ...
    ya.prototype.callbacks.push(function (a) {
        ...
        g && (A(a.xAxis[0], "afterSetExtremes", d), U(a, "drawChartBox", function (a) {
    ...
    Highcharts.StockChart = function (a, b) {
        var c = a.series, d, e = o(a.navigator && a.navigator.enabled, !0) ? {startOnTick: !1, endOnTick: !1} : null, f = {marker: {enabled: !1, states: {hover: {radius: 5}}}, states: {hover: {lineWidth: 2}}}, g = {shadow: !1, borderWidth: 0};
        a.xAxis = Na(ja(a.xAxis || {}), function (a) {
        ...
        a.yAxis = Na(ja(a.yAxis ||
        {}), function (a) {
            d = a.opposite;
            return w({labels: {align: d ? "right" : "left", x: d ? -2 : 2, y: -2}, showLastLabel: !1, title: {text: null}}, a)
        });
        a.series = null;
    ...
    U(W.prototype, "drawCrosshair", function (a, b, c) {
        ...
        if (t(this.crosshair.label) && this.crosshair.label.enabled && t(c)) {
            var a = this.chart, f = this.options.crosshair.label, g = this.isXAxis ? "x" : "y", b = this.horiz,
                h = this.opposite, i = this.left, j = this.top, k = this.crossLabel, l, m, p = f.format, n = "";
            ...
            if (m < j || m > j + this.height)this.hideCrosshair(); else {
                !p && !f.formatter && (this.isDatetimeAxis && (n = "%b %d, %Y"), p = "{value" + (n ? ":" + n : "") + "}");
                k.attr({x: l, y: m, text: p ? Ha(p, {value: c[g]}) : f.formatter.call(this, c[g]), visibility: "visible"});
                c = k.box;
                if (b) {
                    if (this.options.tickPosition === "inside" && !h || this.options.tickPosition !== "inside" && h)m = k.y - c.height
                } else m = k.y - c.height / 2;
                b ? (d = i - c.x, e = i + this.width - c.x) : (d = this.labelAlign === "left" ? i : 0, e = this.labelAlign ===
                    "right" ? i + this.width : a.chartWidth);
    ...
    var kc = Y.init, lc = Y.processData, mc = Da.prototype.tooltipFormatter;
    Y.init = function () {
    ...
    Da.prototype.tooltipFormatter = function (a) {
        a = a.replace("{point.change}", (this.change > 0 ? "+" : "") + Ga(this.change, o(this.series.tooltipOptions.changeDecimals, 2)));
        return mc.apply(this, [a])
    };
    u(Highcharts, {Axis: W, Chart: ya, Color: Ba, Point: Da, Tick: Ya, Tooltip: Ab, Renderer: Za, Series: M, SVGElement: xa, SVGRenderer: sa, arrayMin: Ra, arrayMax: va, charts: Wa, dateFormat: ra, format: Ha, pathAnim: Eb, getOptions: function () {
        return L
    }, hasBidiBug: Yb, isTouchDevice: cb, numberFormat: Ga, seriesTypes: D, setOptions: function (a) {
        L =
            w(!0, L, a);
        Lb();
        return L
