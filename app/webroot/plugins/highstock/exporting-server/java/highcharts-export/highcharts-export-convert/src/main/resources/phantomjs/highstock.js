...
(function () {
    ...
    function I(a, b, c) {
        var d, e;
        if (ka(b))r(c) ?
            a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (r(b) && ba(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    function Ja(a, b) {
        for (var c = "{", d = !1, e, f, g, h, i, k = []; (c = a.indexOf(c)) !== -1;) {
            ...
            if (d) {
                ...
                if (f.length)f = f.join(":"), g = /\.([0-9])/, h = G.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e = Ia(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : "")) : e = ra(f, e)
            }
            k.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    Bb = {init: function (a, b, c) {
        var b = b || "", d = a.shift, e = b.indexOf("C") > -1, f = e ? 7 : 3, g, b = b.split(" "), c = [].concat(c), h, i, k = function (a) {
            for (g = a.length; g--;)a[g] === "M" && a.splice(g + 1, 0, a[g + 1], a[g +
                2], a[g + 1], a[g + 2])
        };
        e && (k(b), k(c));
        ...
        var e = [], f = a.length;
        if (c === 1)e = d; else if (f === b.length && c < 1)for (; f--;)d = parseFloat(a[f]), e[f] = isNaN(d) ? a[f] : c * parseFloat(b[f] -
            d) + d; else e = b;
        return e
    }};
    (function (a) {
        U.HighchartsAdapter = U.HighchartsAdapter || a && {init: function (b) {
            ...
            a.each(["cur", "_default", "width", "height", "opacity"], function (a, b) {
                ...
                (j = e[b]) && (e[b] = function (c) {
                    var d, c = a ? c : this;
                    if (c.prop !== "align")return d = c.elem, d.attr ? d.attr(c.prop, b === "cur" ? s : c.now) :
            ...
            a.fn.highcharts = function () {
                ...
                c = b[0];
                if (c !== s)c.chart = c.chart || {}, c.chart.renderTo = this[0], new Q[a](c, b[1]), d = this;
    ...
    Ca.prototype = {init: function (a, b) {
        ...
        if (ka(a))c = a, h === "circle" ? c = {x: "cx",
            y: "cy"}[c] || c : c === "strokeWidth" && (c = "stroke-width"), p = I(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && c !== "fill" && (p = parseFloat(p)); else {
            for (c in a)if (k = !1, d = a[c], e = j[c] && j[c].call(this, d, c), e !== !1) {
                e !== s && (d = e);
                if (c === "d")d && d.join && (d = d.join(" ")), /(NaN| {2}|^$)/.test(d) && (d = "M 0 0"); else if (c === "x" && h === "text")for (e = 0; e < g.childNodes.length; e++)f = g.childNodes[e], I(f, "x") === I(g, "x") && I(f, "x", d); else if (this.rotation && (c === "x" || c === "y"))o = !0; else if (c === "fill")d = i.color(d, g, c); else if (h === "circle" &&
                    (c === "x" || c === "y"))c = {x: "cx", y: "cy"}[c] || c; else if (h === "rect" && c === "r")I(g, {rx: d, ry: d}), k = !0; else if (c === "translateX" || c === "translateY" || c === "rotation" || c === "verticalAlign" || c === "scaleX" || c === "scaleY")k = o = !0; else if (c === "stroke")d = i.color(d, g, c); else if (c === "dashstyle")if (c = "stroke-dasharray", d = d && d.toLowerCase(), d === "solid")d = X; else {
                    if (d) {
                ...
                } else if (c === "width")d = y(d); else if (c === "align")c = "text-anchor", d = {left: "start", center: "middle", right: "end"}[d]; else if (c === "title")e = g.getElementsByTagName("title")[0], e || (e = C.createElementNS(Na, "title"), g.appendChild(e)), e.textContent = d;
                c === "strokeWidth" && (c = "stroke-width");
                if (c === "stroke-width" || c === "stroke") {
                    this[c] = d;
                    if (this.stroke && this["stroke-width"])I(g,
                        "stroke", this.stroke), I(g, "stroke-width", this["stroke-width"]), this.hasStroke = !0; else if (c === "stroke-width" && d === 0 && this.hasStroke)g.removeAttribute("stroke"), this.hasStroke = !1;
                    k = !0
                }
        ...
        if (b)for (f in a)a[f] !== b[f] && (c[f] = a[f],
            e = !0);
        if (e) {
        ...
        f = e.alignedObjects;
        if (a) {
            if (this.alignOptions = a, this.alignByTranslate = b, !c || ka(c))this.alignTo = d = c || "renderer", ma(f,
        ...
        d = this.textStr;
        var h;
        if (d === "" || Zb.test(d))h = d.toString().length + (f ? "|" + f.fontSize + "|" + f.fontFamily : ""), a = b.cache[h];
        if (!a) {
        ...
        if (a) {
            ...
            for (e = 1; e <= i; e++) {
                ...
                if (c)I(f, "height", v(I(f, "height") - h, 0)), f.cutHeight = h;
    ...
    ha.prototype = {Element: Ca, init: function (a, b, c, d, e) {
        ...
        q(e, function (e, f) {
            ...
            q(l, function (e) {
                if (e !== "" || l.length === 1) {
                    ...
                    if (e !== " " && (n.appendChild(C.createTextNode(e)), m ? p.dx = 0 : p.x = i, I(n, p), !m && f && (!$ && d && J(n, {display: "block"}), I(n, "dy", o(n), mb && n.offsetHeight)), b.appendChild(n), m++, j))for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "),
        ...
        var k = this.label(a, b, c, i, null, null, null, null, "button"), j = 0, l, m, o, p, B, n, a = {x1: 0, y1: 0, x2: 0, y2: 1}, e = w({"stroke-width": 1, stroke: "#CCCCCC", fill: {linearGradient: a, stops: [
            [0, "#FEFEFE"],
            [1, "#F6F6F6"]
        ...
        if (h)g = this.path(h), u(g, {symbolName: a, x: b, y: c, width: d, height: e}), f && u(g, f); else if (i.test(a))j = function (a, b) {
        ...
        function k() {
            ...
            Fa = K + m.fontMetrics(a &&
                a.fontSize).b;
            if (x) {
                if (!B)a = t(-z * K), b = h ? -Fa : 0, o.box = B = d ? m.symbol(d, a, b, o.width, o.height, E) : m.rect(a, b, o.width, o.height, 0, E[Tb]), B.attr("fill", X).add(o);
        ...
        function j() {
            ...
            c = h ? 0 : Fa;
            if (r(cb) && n && (a === "center" || a === "right"))b += {center: 0.5, right: 1}[a] * (cb - n.width);
        ...
        if (this.added) {
            ...
            if (b.tagName === "SPAN") {
                ...
                if (m !== this.cTT) {
                    ...
                    if (i > l && /[ \-]/.test(b.textContent || b.innerText))J(b, {width: l + "px", display: "block", whiteSpace: "normal"}), i = l;
    ...
    var fb, pa;
    if (!$ && !ga)Q.VMLElement = pa = {init: function (a, b) {
        ...
        for (var b = a.length, c = []; b--;)if (za(a[b]))c[b] = t(a[b] * 10) - 5; else if (a[b] === "Z")c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at"))c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1);
        return c.join(" ") || "x"
    }, attr: function (a, b) {
        ...
        ka(a) && r(b) && (c = a, a = {}, a[c] = b);
        if (ka(a))c = a, p = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c]; else for (c in a)if (d = a[c], m = !1, e = o[c] && o[c].call(this, d, c), e !== !1 && d !== null) {
            e !== s && (d = e);
            if (k && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))j || (this.symbolAttr(a), j = !0), m = !0; else if (c === "d") {
                ...
                g[c] = d;
                m = !0
            } else if (c === "zIndex")d && (g[c] = d), m = !0; else if (ua(c, ["x", "y", "width", "height"]) !== -1)this[c] = d, c === "x" || c === "y" ? c = {x: "left", y: "top"}[c] : d = v(0, d), this.updateClipping ? (this[c] = d, this.updateClipping()) : g[c] = d, m = !0; else if (c === "class" && h === "DIV")f.className = d; else if (c === "stroke")d = i.color(d, f, c), c = "strokecolor";
            else if (c === "stroke-width" || c === "strokeWidth")f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, za(d) && (d += "px"); else if (c === "dashstyle")(f.getElementsByTagName("stroke")[0] || Y(i.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid", this.dashstyle = d, m = !0; else if (c === "fill")if (h === "SPAN")g.color = d; else {
                if (h !== "IMG")f.filled = d !== X ? !0 : !1, d = i.color(d, f, c, this), c = "fillcolor"
            } else if (c === "opacity")m = !0; else if (h === "shape" && c === "rotation")this[c] = f.style[c] = d, f.style.left = -t(fa(d * Ma) + 1) + "px", f.style.top = t(aa(d *
                Ma)) + "px"; else if (c === "translateX" || c === "translateY" || c === "rotation")this[c] = d, this.updateTransform(), m = !0;
            m || (lb ? f[c] = d : I(f, c, d))
        }
        return p
    }, clip: function (a) {
        ...
        isHidden: function () {
            ...
            if (i) {
                ...
                if (c === "fill")if (i === "gradient")c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, K = 'angle="' + (90 - W.atan((m - a) / (o - c)) * 180 / oa) + '"', t(); else {
            ...
            } else if (g.test(a) && b.tagName !== "IMG")f = Ea(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], Y(this.prepVML(h), null, null, b), k = f.get("rgb"); else {
    ...
    $a.prototype = {addLabel: function () {
        ...
        if (m) {
            ...
            do a += e ? 1 : -1, o = d.ticks[i[a]]; while (i[a] && (!o || o.label.line !== p));
        ...
        if (m && z)r === "inside" && (z = -z), d.opposite && (z = -z), h = this.getMarkPath(x, w, z, m * E, g, f), o ? o.animate({d: h, opacity: c}) : this.mark = f.path(h).attr({stroke: K, "stroke-width": m, opacity: c}).add(d.axisGroup);
        if (i && !isNaN(x))i.xy = w = this.getLabelPosition(x, w, i, g, j, u, a, t), this.isFirst && !this.isLast && !n(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !n(e.showLastLabel, 1) ? v = !1 : !d.isRadial && !j.step && !j.rotation && !b && c !== 0 && (v = this.handleOverflow(a, w)), t && a % t && (v = !1), v && !isNaN(w.y) ? (w.opacity = c, i[this.isNew ? "attr" : "animate"](w), this.isNew = !1) : i.attr("y", -9999)
    }, destroy: function () {
        Ka(this, this.axis)
    }};
    ...
    Q.PlotLineOrBand.prototype = {render: function () {
        ...
        if (h) {
            if (p = b.getPlotLinePath(l, h), d = {stroke: q, "stroke-width": h}, m)d.dashstyle = m
        } else if (j) {
            if (k = v(k, b.min - d), i = x(i, b.max + d), p = b.getPlotBandPath(k, i, e), d = {fill: q}, e.borderWidth)d.stroke = e.borderColor, d["stroke-width"] = e.borderWidth
        } else return;
        if (r(z))d.zIndex =
            z;
        if (o)if (p)o.animate({d: p}, null, o.onGetPath); else {
        ...
        if (f && r(f.text) && p && p.length && b.width > 0 && b.height > 0) {
            ...
            if (!g)a.label = g = s.text(f.text, 0, 0, f.useHTML).attr({align: f.textAlign || f.align, rotation: f.rotation,
    ...
    N.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M", hour: "%H:%M", day: "%e. %b", week: "%e. %b", month: "%b '%y", year: "%Y"}, endOnTick: !1, gridLineColor: "#C0C0C0", labels: F, lineColor: "#C0D0E0",
        ...
        if (this.isLog)this.val2lin = Ga, this.lin2val = la
        ...
        if (h)g = Ja(h, this); else if (c)g = b; else if (d)g = ra(d, b); else if (f && a >= 1E3)for (; f-- && g === s;)c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Ia(b / c, -1) + e[f]);
        ...
        q(a.series, function (c) {
            if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                ...
                a.isLog && d <= 0 && (d = null);
                if (a.isXAxis) {
                    if (d = c.xData, d.length)a.dataMin = x(n(a.dataMin, d[0]), Sa(d)), a.dataMax = v(n(a.dataMax, d[0]), Aa(d))
                } else {
                    c.getExtremes();
                    e = c.dataMax;
                    c = c.dataMin;
                    if (r(c) && r(e))a.dataMin = x(n(a.dataMin, c), c), a.dataMax = v(n(a.dataMax, e), e);
        ...
        if (this.isXAxis && this.minRange === s && !this.isLog)r(a.min) || r(a.max) ? this.minRange = null : (q(this.series, function (a) {
            i = a.xData;
        ...
        if (e)!a && x(b.min, n(b.dataMin, b.min)) <= 0 && na(10, 1), b.min = ea(Ga(b.min)), b.max = ea(Ga(b.max));
        if (b.range && r(b.max))b.userMin = b.min = v(b.min, b.max - b.range), b.userMax =
            b.max, b.range = null;
        ...
        if (!a)!b.ordinalPositions && (b.max - b.min) / b.tickInterval > v(2 * b.len, 200) && na(19, !0), a = f ? b.getTimeTicks(b.normalizeTimeTickInterval(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : e ? b.getLogTickPositions(b.tickInterval, b.min,
            b.max) : b.getLinearTickPositions(b.tickInterval, b.min, b.max), p && a.splice(1, a.length - 2), b.tickPositions = a;
        if (!h)e = a[0], f = a[a.length - 1], h = b.minPointOffset || 0, d.startOnTick ? b.min = e : b.min - h > e && a.shift(), d.endOnTick ? b.max = f : b.max + h < f && a.pop(), a.length === 1 && (d = O(b.max || 1) * 0.001, b.min -= d, b.max += d)
        ...
        if (!a.axisGroup)a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(), a.labelGroup = c.g("axis-labels").attr({zIndex: p.zIndex || 7}).addClass("highcharts-" +
        ...
        if (k || a.isLinked) {
            ...
            if (a.horiz && !a.staggerLines && w && !p.rotation) {
                for (t = a.reversed ? [].concat(e).reverse() : e; u < w;) {
                    k = [];
                    x = !1;
                    for (p = 0; p < t.length; p++)y = t[p], D = (D = f[y].label && f[y].label.getBBox()) ? D.width : 0, E = p % u, D && (y = a.translate(y), k[E] !== s && y < k[E] && (x = !0), k[E] = y + D);
                    if (x)u++; else break
                }
            ...
            q(e, function (b) {
                if (h === 0 || h === 2 || {1: "left", 3: "right"}[h] ===
                    a.labelAlign)B = v(f[b].getLabelSize(), B)
            });
            if (a.staggerLines)B *= a.staggerLines, a.labelOffset = B
        ...
        if (o && o.text && o.enabled !== !1) {
            ...
            if (b)j = a.axisTitle.getBBox()[g ? "height" : "width"], m = n(o.margin,
                g ? 5 : 10), l = o.offset;
        ...
        if (t || h)if (a.minorTickInterval && !a.categories && q(a.getMinorTickPositions(), function (b) {
            ...
            if (!h || b >= a.min && b <= a.max)l[b] || (l[b] = new $a(a, b)), K && l[b].isNew && l[b].render(c, !0, 0.1), l[b].render(c, !1, 1)
        }), n && a.min === 0 && (l[-1] || (l[-1] = new $a(a, -1, null, !0)), l[-1].render(-1))), B && q(i, function (b, c) {
            if (c % 2 === 0 && b < a.max)o[b] || (o[b] = new Q.PlotLineOrBand(a)), u = b + n, y = i[c + 1] !== s ? i[c + 1] + n : a.max, o[b].options = {from: g ?
        ...
        if (z)b = a.getLinePath(z), a.axisLine ? a.axisLine.animate({d: b}) :
            a.axisLine = e.path(b).attr({stroke: f.lineColor, "stroke-width": z, zIndex: 7}).add(a.axisGroup), a.axisLine[v ? "show" : "hide"]();
        if (j && v)j[j.isNew ? "attr" : "animate"](a.getTitlePosition()), j.isNew = !1;
        ...
        if (this.crosshair)if ((r(b) || !n(this.crosshair.snap, !0)) === !1)this.hideCrosshair(); else {
    ...
    N.prototype.getTimeTicks = function (a, b, c, d) {
        ...
        if (r(b)) {
            ...
            h = i[kb]();
            for (var d = i.getTime(), l = i[jb](), m = i[Va](), o = g ? La : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;)e.push(d), k === A.year ? d = ib(h + b * j, 0) : k === A.month ? d = ib(h, l + b * j) : !g && (k === A.day || k === A.week) ? d = ib(h, l, m + b * j * (k === A.day ? 1 : 7)) : d += k * j, b++;
            e.push(d);
            q(Cb(e, function (a) {
                return k <=
                    A.hour && a % A.day === o
    ...
    N.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5)a = t(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = T(b), h, i, k, j, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
            i = e.length;
            for (h = 0; h < i && !l; h++)k = Ga(la(f) * e[h]), k > b && (!d || j <= c) && g.push(j), j > c && (l = !0), j = k
        } else if (b = la(b), c = la(c),
            a = e[d ? "minorTickInterval" : "tickInterval"], a = n(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = sb(a, null, rb(a)), g = va(this.getLinearTickPositions(a, b, c), Ga), !d)this._minorAutoInterval = a / 5;
    ...
    Ya.prototype = {init: function (a, b) {
        ...
        if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
            f = [];
            i = c.length;
            for (k = 0; k < i; k++)if (c[k].visible && c[k].options.enableMouseTracking !== !1 && !c[k].noSharedTooltip && c[k].singularTooltips !== !0 && c[k].tooltipPoints.length && (e = c[k].tooltipPoints[l]) && e.series)e._dist = O(l - e.clientX), j = x(j, e._dist), f.push(e);
        ...
        if (a)e.refresh(f), d && d.setState(d.state, !0); else {
            ...
            if (c)c.onMouseOut();
            e && e.hide();
            if (this._onDocumentMouseMove)S(C, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null;
            q(b.axes, function (a) {
                a.hideCrosshair()
            });
            this.hoverX = null
        ...
        if (b)J(b.container, {cursor: b._cursor}), b.cancelClick = this.hasDragged > 10, b.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = []
    ...
    u(Q.Pointer.prototype, {pinchTranslate: function (a, b, c, d, e, f, g, h) {
        ...
        if (a.type === "touchstart")q(f, function (a, b) {
            ...
            if (!l)b.selectionMarker = l = u({destroy: ta}, c.plotBox);
    ...
    if (U.PointerEvent || U.MSPointerEvent) {
        var wa = {}, Hb = !!U.PointerEvent, fc = function () {
            ...
            a = a.originalEvent || a;
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && da[ja])d(a), d = da[ja].pointer, d[b]({type: c, target: a.currentTarget, preventDefault: ta, touches: fc()})
        };
    ...
    {init: function (a, b) {
        ...
        this.options = b;
        if (b.enabled)c.baseline = y(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = w(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.symbolWidth = n(b.symbolWidth, 16), c.pages = [], c.render(), D(c.chart, "endResize", function () {
        ...
        e && e.attr({stroke: h});
        if (f) {
            if (g && f.isMarker)for (k in g = a.convertAttribs(g), g)d = g[k], d !== s && (i[k] = d);
            f.attr(i)
        }
        ...
        if (!q)a.legendGroup = c.g("legend-item").attr({zIndex: 1}).add(this.scrollGroup), z.drawLegendSymbol(this, a), a.legendItem = q = c.text(d.labelFormat ? Ja(d.labelFormat, a) : d.labelFormatter.call(a),
        ...
        if (e && this.itemX - B + f > (m || b.chartWidth - 2 * k - B - d.x))this.itemX = B, this.itemY += p + this.lastLineHeight + o, this.lastLineHeight = 0;
        ...
        if (l || m) {
            ...
            } else a.box = i = c.rect(0, 0, g, h, k.borderRadius, l || 0).attr({stroke: k.borderColor, "stroke-width": l || 0, fill: m || X}).add(d).shadow(k.shadow), i.isNew = !0;
            i[f ? "show" : "hide"]()
        }
        a.legendWidth = g;
        a.legendHeight = h;
        ...
        e > d && (e = d);
        if (e > 0)b !== s && Za(b, this.chart), this.nav.attr({translateX: k, translateY: f + this.padding + 7 + this.titleHeight, visibility: "visible"}), this.up.attr({fill: e === 1 ? g : h}).css({cursor: e ===
    ...
    sa.prototype = {init: function (a, b) {
        ...
        setTitle: function (a, b, c) {
            ...
            var b = 0, c = this.title, d = this.subtitle, e = this.options, f = e.title, e = e.subtitle, g = this.spacingBox.width -
                44;
            if (c && (c.css({width: (f.width || g) + "px"}).align(u({y: 15}, f), !1, "spacingBox"), !f.floating && !f.verticalAlign))b = c.getBBox().height, b >= 18 && b <= 25 && (b = 15);
            d && (d.css({width: (e.width || g) + "px"}).align(u({y: b + f.margin}, e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = Wa(b + d.getBBox().height)));
            c = this.titleOffset !== b;
            this.titleOffset = b;
            if (!this.isDirtyBox && c)this.isDirtyBox = c, this.hasRendered && n(a, !0) && this.isDirtyBox && this.redraw()
            ...
            o = i + (a.shadow ? 8 : 0);
            if (i || k)if (e)e.animate(e.crisp({width: c -
                o, height: d - o})); else {
                e = {fill: k || X};
            ...
            if (j)f ? f.animate(s) : this.plotBackground = b.rect(p, n, q, z, 0).attr({fill: j}).add().shadow(a.plotShadow);
            ...
            if (m)g ? g.animate(g.crisp({x: p, y: n, width: q, height: z})) : this.plotBorder =
    ...
    xa.prototype = {init: function (a, b, c) {
        ...
        if (typeof a === "number" || a === null)b[d[0]] = a; else if (Qa(a)) {
            if (a.length > e) {
                c = typeof a[0];
                if (c === "string")b.name =
    ...
    M.prototype = {isCartesian: !0, type: "line", pointClass: xa, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, axisTypes: ["xAxis", "yAxis"], colorCounter: 0, parallelArrays: ["x", "y"], init: function (a, b) {
        ...
        if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData)q(a, function (a, b) {
            ...
            if (p && h > p) {
                ...
                if (za(j)) {
                    ...
                    for (c =
                             0; c < h; c++)B[c] = m, Oa[c] = a[c], m += i;
                    e.xIncrement = m
                } else if (Qa(j))if (z)for (c = 0; c < h; c++)i = a[c], B[c] = i[0], Oa[c] = i.slice(1, z + 1); else for (c = 0; c < h; c++)i = a[c], B[c] = i[0], Oa[c] = i[1]; else na(12)
            } else for (c = 0; c < h; c++)if (a[c] !== s && (i = {series: e}, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c), m && i.name))l.names[i.x] = i.name;
            ka(Oa[0]) && na(14, !0);
            e.data = [];
            e.options.data = a;
        ...
        for (h = b.length - 1; h >= 0; h--)d = b[h] - b[h - 1], d > 0 && (g === s || d < g) ? g =
        ...
        for (m = 0; m < g; m++)i = h + m, k ? l[m] = (new f).init(this, [d[m]].concat(ia(e[m]))) : (b[i] ? j = b[i] : a[i] !== s && (b[i] = j = (new f).init(this, a[i], d[m])), l[m] = j);
        ...
        d = a.length;
        for (l = 0; l < d; l++)if (k = c[l], j = a[l], i = j !== null && j !== s && (!b.isLog || j.length || j > 0), k = this.getExtremesFromAll || this.cropped || (c[l + 1] || k) >= g && (c[l - 1] || k) <= h, i && k)if (i = j.length)for (; i--;)j[i] !== null && (e[f++] = j[i]); else e[f++] = j;
        ...
        for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories,
            ...
            if (b && this.visible && q && q[m])q = q[m], o = q.points[this.index], p = o[0], o = o[1], p === 0 && (p = n(j, e.min)), e.isLog && p <= 0 && (p = null), l.total = l.stackTotal = q.total, l.percentage = q.total && l.y / q.total * 100, l.stackY = o, q.setOffset(this.pointXOffset ||
                0, this.barW || 0);
        ...
        if (l.enabled || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = T(g.plotX), e = g.plotY, j = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled === s || i.enabled, o = c.isInsidePlot(t(d), e, c.inverted), a && e !== s && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = n(i.symbol, this.symbol), k = i.indexOf("url") ===
            0, j)j.attr({visibility: o ? "inherit" : "hidden"}).animate(u({x: d - h, y: e - h}, j.symbolName ? {width: 2 * h, height: 2 * h} : {})); else {
        ...
        q(a.axisTypes || [], function (b) {
            if (i = a[b])ma(i.series, a), i.isDirty = i.forceRedraw = !0
        });
        ...
        q(c, function (c, h) {
            var j = c[0], l = a[j];
            if (l)eb(l), l.animate({d: g}); else if (d && g.length)l = {stroke: c[1], "stroke-width": d, fill: X, zIndex: 1}, e ? l.dashstyle = e : f && (l["stroke-linecap"] =
        ...
        if (d && (f || g)) {
            ...
            if (b.inverted)a.height = j.y = b.plotWidth - d, c.isVML && (a = {x: b.plotWidth -
    ...
    M.prototype.setPercentStacks = function () {
        ...
        q([b, "-" + b], function (b) {
            var e;
            for (var f = d.length, g, h; f--;)if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index], g = e)h = h.total ? 100 / h.total : 0, g[0] = ea(g[0] * h), g[1] = ea(g[1] * h), a.stackedYData[f] = g[1]
        })
    };
    u(sa.prototype, {addSeries: function (a, b, c) {
        ...
        if (!c)this.loadingDiv = c = Y(Ua, {className: "highcharts-loading"}, u(d.style, {zIndex: 10, display: X}), this.container), this.loadingSpan = Y("span", null, d.labelStyle, c);
    ...
    u(M.prototype, {addPoint: function (a, b, c, d) {
        ...
        if (!c.isRemoving)c.isRemoving = !0, P(c, "remove", null, function () {
            c.destroy();
    ...
    var qa = ca(M, {type: "area", getSegments: function () {
        ...
        if (this.options.stacking && !this.cropped) {
            ...
            q(c, function (a) {
                if (!j || g[a] && g[a].y !== null)g[a] ? b.push(g[a]) : (h = d.translate(a), l = f[a].percent ? f[a].total ? f[a].cum * 100 / f[a].total : 0 : f[a].cum, i = e.toPixels(l, !0), b.push({y: null, plotX: h, clientX: h, plotY: i, yBottom: i, onMouseOver: ta}))
            });
            b.length && a.push(b)
        ...
        if (e.stacking && !this.closedStacks)for (d = a.length - 1; d >= 0; d--)g = n(a[d].yBottom, f), d < a.length - 1 && e.step && c.push(a[d + 1].plotX, g), c.push(a[d].plotX, g); else this.closeSegment(c, a, f);
    ...
    ya = ca(M, {type: "column", pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color", r: "borderRadius"}, cropShoulder: 0, trackerGroups: ["group",
        ...
        q(a.points, function (f) {
            ...
            if (g !== s && !isNaN(g) && f.y !== null)e = f.shapeArgs, h ? (eb(h), h[a.points.length < d ? "animate" : "attr"](w(e))) : f.graphic = c[f.shapeType](e).attr(f.pointAttr[f.selected ? "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius); else if (h)f.graphic = h.destroy()
        })
    }, animate: function (a) {
        var b =
    ...
    L = {type: "pie", isCartesian: !1, pointClass: ca(xa, {init: function () {
        ...
        var a = this, b;
        if (a.y < 0)a.y = null;
        u(a, {visible: a.visible !== !1, name: n(a.name, "Slice")});
        b = function (b) {
    ...
    if (H.pie)H.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = n(e.connectorPadding,
            10), g = n(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, i, k, j = n(e.softConnector, !0), l = e.distance, m = a.center, o = m[2] / 2, p = m[1], B = l > 0, s, z, r, u, w = [
            [],
            []
        ], x, y, D, C, E, A = [0, 0, 0, 0], H = function (a, b) {
            return b.y - a.y
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (C = 0; !u && b[C];)u = b[C] && b[C].dataLabel && (b[C].dataLabel.getBBox().height || 21), C++;
            for (C = 2; C--;) {
                ...
                if (l >
                    ...
                    for (E = 0; E < G; E++) {
                        ...
                        c = 9999;
                        var N, L;
                        for (L = 0; L < z; L++)N = O(b[L] - r[1]), N < c && (c = N, F = L);
                        if (F < E && b[E] !== null)F = E; else for (z < G - E + F && b[E] !== null && (F = z - G + E); b[F] === null;)F++;
                        I.push({i: F, y: b[F]});
                        b[F] = null
                    }
                    I.sort(H)
                ...
                for (E = 0; E < G; E++) {
                    ...
                    if (l > 0) {
                        if (z = I.pop(), F = z.i,
                            y = z.y, c > y && b[F + 1] !== null || c < y && b[F - 1] !== null)y = c
                    } else y = c;
                    ...
                    s.connX = x;
                    s.connY = y;
                    if (this.options.size === null)z = s.width, x - z < f ? A[3] = v(t(z - x + f), A[3]) : x + z > h - f && (A[1] = v(t(x + z - h + f), A[1])), y - u / 2 < 0 ? A[0] = v(t(-y + u / 2), A[0]) : y + u / 2 > d && (A[2] = v(t(y + u / 2 - d), A[2]))
                }
            }
            if (Aa(A) === 0 || this.verifyDataLabelOverflow(A))this.placeDataLabels(), B && g && q(this.points, function (b) {
                i =
                    b.connector;
                r = b.labelPos;
                if ((s = b.dataLabel) && s._pos)D = s._attr.visibility, x = s.connX, y = s.connY, k = j ? ["M", x + (r[6] === "left" ? 5 : -5), y, "C", x, y, 2 * r[2] - r[4], 2 * r[3] - r[5], r[2], r[3], "L", r[4], r[5]] : ["M", x + (r[6] === "left" ? 5 : -5), y, "L", r[2], r[3], "L", r[4], r[5]], i ? (i.animate({d: k}), i.attr("visibility", D)) : b.connector = i = a.chart.renderer.path(k).attr({"stroke-width": g, stroke: e.connectorColor || b.color || "#606060", visibility: D}).add(a.group); else if (i)b.connector = i.destroy()
            })
        }
    ...
    if (H.column)H.column.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        if (h && (d = w(h), g && (d = {x: f.plotWidth - d.y - d.height, y: f.plotHeight - d.x - d.width, width: d.height, height: d.width}), !k))g ? (d.x += i ? 0 : d.width, d.width = 0) : (d.y += i ? d.height : 0, d.height = 0);
    ...
    u(sa.prototype, {showResetZoom: function () {
        ...
        if (d && !e)this.showResetZoom(); else if (!d && ba(e))this.resetZoomButton = e.destroy();
    ...
    u(xa.prototype, {select: function (a, b) {
        ...
        if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && !i.enabled) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
            if (this.graphic)f = g && this.graphic.symbolName && o[a].r, this.graphic.attr(w(o[a], f ? {x: c -
                f, y: d - f, width: 2 * f, height: 2 * f} : {})); else {
                if (a && i)if (f = i.radius, l = l.symbol || e.symbol, j && j.currentSymbol !== l && (j = j.destroy()), j)j[b ? "animate" : "attr"]({x: c - f, y: d - f}); else e.stateMarkerGraphic = j = m.renderer.symbol(l, c - f, d - f, 2 * f, 2 * f).attr(o[a]).add(e.markerGroup), j.currentSymbol = l;
    ...
    R(N.prototype, "getTimeTicks", function (a, b, c, d, e, f, g, h) {
        ...
        if (h && r(z)) {
            ...
            for (m = []; h--;)i = this.translate(n[h]), t && (m[h] = t - i), k[h] = t = i;
            m.sort();
            m = m[T(m.length / 2)];
            m < z * 0.6 && (m = null);
            h = n[a - 1] > d ? a - 1 : a;
            for (t = void 0; h--;)i = k[h], d = t - i, t && d < z * 0.8 && (m === null || d < m * 0.8) ? (l[n[h]] && !l[n[h + 1]] ? (d = h + 1, t = i) : d = h, n.splice(d, 1)) : t = i
        }
        return n
    });
    ...
    var Z = M.prototype, L = Gb.prototype, gc = Z.processData, hc = Z.generatePoints, ic = Z.destroy, jc = L.tooltipHeaderFormatter, kc = {approximation: "average", groupPixelWidth: 2, dateTimeLabelFormats: Jb("millisecond", ["%A, %b %e, %H:%M:%S.%L",
        ...
        areasplinerange: {approximation: "range"}, columnrange: {approximation: "range", groupPixelWidth: 10}, candlestick: {approximation: "ohlc", groupPixelWidth: 10}, ohlc: {approximation: "ohlc", groupPixelWidth: 5}}, Xb = [
        ["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]],
        ["second", [1, 2, 5, 10, 15, 30]],
        ["minute", [1, 2, 5, 10, 15, 30]],
        ["hour", [1, 2, 3, 4, 6, 8, 12]],
    ...
    Z.groupData = function (a, b, c, d) {
        var e = this.data, f = this.options.data, g = [], h = [], i = a.length, k, j, l = !!b, m = [
            ...
            [],
            []
        ], d = typeof d === "function" ? d : Pa[d], o = this.pointArrayMap, p = o && o.length, n;
        ...
        for (; n <= i; n++) {
            ...
            if (o) {
                ...
                var q;
                for (j = 0; j < p; j++)if (q = k[o[j]], typeof q === "number")m[j].push(q); else if (q === null)m[j].hasNulls = !0
            } else if (k = l ? b[n] : null, typeof k === "number")m[0].push(k); else if (k === null)m[0].hasNulls = !0
        }
        return[g, h]
    };
    ...
    L.tooltipHeaderFormatter = function (a) {
        ...
        if (g && g.options.type === "datetime" && d && za(a.key)) {
            ...
            if (b)g = d[b.unitName], b.count === 1 ? e = g[0] : (e = g[1], f = g[2]); else if (!e && d)for (h in A)if (A[h] >= g.closestPointRange || A[h] <= A.day && a.key % A[h] > 0) {
                e = d[h][0];
                break
            }
            e = ra(e, a.key);
    ...
    R(Z, "setOptions", function (a, b) {
        ...
        if (Wb[d])f || (f = w(kc, Wb[d])), c.dataGrouping = w(f, e.series && e.series.dataGrouping, e[d].dataGrouping, b.dataGrouping);
    ...
    L = ca(H.column, {type: "ohlc", pointArrayMap: ["open", "high", "low", "close"], toYData: function (a) {
        ...
        q(a.points, function (j) {
            if (j.plotY !== s)i = j.graphic, c = j.pointAttr[j.selected ? "selected" : ""], f = c["stroke-width"] % 2 / 2, k = t(j.plotX) - f, g = t(j.shapeArgs.width / 2), h =
    ...
    L = ca(L, {type: "candlestick", pointAttrToOptions: {fill: "color", stroke: "lineColor", "stroke-width": "lineWidth"},
        upColorProp: "fill", getAttribs: function () {
            ...
            q(a.points, function (n) {
                m = n.graphic;
                if (n.plotY !== s)c = n.pointAttr[n.selected ? "selected" : ""] ||
    ...
    H.flags = ca(H.column, {type: "flags", sorted: !1, noSharedTooltip: !0, takeOrdinalPosition: !1, trackerGroups: ["markerGroup"], forceCrop: !0, init: M.prototype.init, pointAttrToOptions: {fill: "fillColor", stroke: "color", "stroke-width": "lineWidth", r: "radius"}, translate: function () {
        ...
        q(b, function (c, d) {
            if (c.plotY ===
                s)c.x >= k.min && c.x <= k.max ? c.plotY = a.chartHeight - i.bottom - (i.opposite ? i.height : 0) + i.offset - a.plotTop : c.shapeArgs = {};
        ...
        for (k = c.length; k--;)if (j = c[k], a = j.plotX > this.xAxis.len, e = j.plotX + (a ? m : -m), l = j.stackIndex, i = j.options.shape || g.shape, f = j.plotY, f !== s && (f = j.plotY + h +
            m - (l !== s && l * g.stackDistance)), o = l ? s : j.plotX + m, n = l ? s : j.plotY, l = j.graphic, f !== s && e >= 0 && !a)a = j.pointAttr[j.selected ? "select" : ""] || b, l ? l.attr({x: e, y: f, r: a.r, anchorX: o, anchorY: n}) : j.graphic = d.label(j.options.title || g.title || "A", e, f, i, o, n, g.useHTML).css(w(g.style, j.style)).attr(a).attr({align: i === "flag" ? "left" : "center", width: g.width, height: g.height}).add(this.markerGroup).shadow(g.shadow), j.tooltipPos = [e, f]; else if (l)j.graphic = l.destroy()
    ...
    L = {linearGradient: {x1: 0, y1: 0, x2: 0, y2: 1}, stops: [
        [0, "#FFF"],
        [1, "#CCC"]
    ]};
    F = [].concat(Xb);
    ...
    yb.prototype = {drawHandle: function (a, b) {
        ...
        if (!isNaN(a)) {
            ...
            c = n(c, l.translate(a));
            d = n(d, l.translate(b));
            if (isNaN(c) || O(c) === Infinity)c = 0, d = k;
            if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                ...
                a = c - b;
                if (!this.rendered) {
                    if (C)this.navigatorGroup = l = f.g("navigator").attr({zIndex: 3}).add(), this.leftShade = f.rect().attr({fill: s.maskFill}).add(l), this.rightShade = f.rect().attr({fill: s.maskFill}).add(l), this.outline = f.path().attr({"stroke-width": D, stroke: s.outlineColor}).add(l);
                    if (q)this.scrollbarGroup = j = f.g("scrollbar").add(), m = r.trackBorderWidth, this.scrollbarTrack = o = f.rect().attr({x: 0, y: -m % 2 / 2, fill: r.trackBackgroundColor, stroke: r.trackBorderColor,
        ...
        a.mouseDownHandler = function (d) {
            ...
            if (t > h && t < h + g + k)if ((h = !a.scrollbarEnabled || t < h + g) && W.abs(r - e - n) < v)a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null; else if (h && W.abs(r - f - n) < v)a.grabbedRight = !0, a.otherHandlePos =
                e, a.fixedExtreme = d.min, b.fixedRange = null; else if (r > n + e - q && r < n + f + q) {
                a.grabbedCenter = r;
                a.fixedWidth = s;
                ...
                if (f < 0)f = 0; else if (f + s >= p)f = p - s, u = c.dataMax;
                if (f !== e)a.fixedWidth = s, e = c.toFixedRange(f, f + s, null, u), d.setExtremes(e.min, e.max, !0, !1, {trigger: "navigator"})
            }
        };
        ...
        if (!a || b.dataMin !== null)return{dataMin: n(d && d.min, (r(b.dataMin) && r(c.dataMin) ? x : n)(b.dataMin, c.dataMin)), dataMax: n(d && d.max, (r(b.dataMax) && r(c.dataMax) ? v : n)(b.dataMax, c.dataMax))}
        ...
        if (a && this.navigatorOptions.adaptToUpdatedData !== !1)D(a, "updatedData", this.updatedDataHandler), a.userOptions.events = u(a.userOptions.event, {updatedData: this.updatedDataHandler})
    ...
    R(N.prototype, "zoom", function (a, b, c) {
        var d = this.chart, e = d.options, f = e.chart.zoomType, g = e.navigator,
            e = e.rangeSelector, h;
        if (this.isXAxis && (g && g.enabled || e && e.enabled))if (f === "x")d.resetZoomButton = "blocked"; else if (f === "y")h = !1; else if (f === "xy")d = this.previousZoom, r(b) ? this.previousZoom = [this.min, this.max] : d && (b = d[0], c = d[1], delete this.previousZoom);
    ...
    R(M.prototype, "addPoint", function (a, b, c, d, e) {
    ...
    zb.prototype = {clickButton: function (a, b) {
        ...
        if (!(k === null || j === null || a === c.selected)) {
            if (p === "month" || p === "year")l = {month: "Month", year: "FullYear"}[p], o["set" + l](o["get" + l]() - r), l = o.getTime(), k = n(k, Number.MIN_VALUE), isNaN(l) || l < k ? (l = k, m = x(l + i, j)) : i = m - l; else if (i)l = v(m - i, k), m = x(l + i, j); else if (p === "ytd")if (h) {
                if (j === s)k = Number.MAX_VALUE, j = Number.MIN_VALUE, q(e.series, function (a) {
                    a = a.xData;
                    k = x(a[0], k);
                    j = v(a[a.length -
                        1], j)
        ...
        for (e in this)this[e] && e !== "chart" && (this[e].destroy ? this[e].destroy() : this[e].nodeType && Ta(this[e])), this[e] = null
    }};
    ...
    if (Xa === Q.VMLRenderer)fb.prototype.crispPolyLine =
